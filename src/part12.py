...
<div class="fig">
<svg viewBox="0 0 600 258" role="img" aria-label="只追加的日志与多个读取位置">
  <text x="40" y="28" font-size="13" style="fill:var(--muted)">WAL · 只追加的日志</text>
  <text x="516" y="28" text-anchor="end" font-size="12.5" font-weight="700" style="fill:var(--accent-ink)">Proxy 追加 →</text>
  <rect x="40" y="42" width="76" height="46" rx="7" style="fill:var(--accent-soft);stroke:var(--accent)"/>
  <text x="78" y="71" text-anchor="middle" font-size="13.5" class="mono" style="fill:var(--accent-ink)">TT100</text>
  <rect x="120" y="42" width="76" height="46" rx="7" style="fill:var(--accent-soft);stroke:var(--accent)"/>
  <text x="158" y="71" text-anchor="middle" font-size="13.5" class="mono" style="fill:var(--accent-ink)">101</text>
  <rect x="200" y="42" width="76" height="46" rx="7" style="fill:var(--accent-soft);stroke:var(--accent)"/>
  <text x="238" y="71" text-anchor="middle" font-size="13.5" class="mono" style="fill:var(--accent-ink)">102</text>
  <rect x="280" y="42" width="76" height="46" rx="7" style="fill:var(--accent-soft);stroke:var(--accent)"/>
  <text x="318" y="71" text-anchor="middle" font-size="13.5" class="mono" style="fill:var(--accent-ink)">103</text>
  <rect x="360" y="42" width="76" height="46" rx="7" style="fill:var(--accent-soft);stroke:var(--accent)"/>
  <text x="398" y="71" text-anchor="middle" font-size="13.5" class="mono" style="fill:var(--accent-ink)">104</text>
  <rect x="440" y="42" width="76" height="46" rx="7" style="fill:var(--accent);stroke:var(--accent)"/>
  <text x="478" y="71" text-anchor="middle" font-size="13.5" class="mono" style="fill:#fff">105</text>
  <path d="M478,88 L478,140" style="fill:none;stroke:var(--teal);stroke-dasharray:3 3"/>
  <path d="M398,88 L398,184" style="fill:none;stroke:var(--accent);stroke-dasharray:3 3"/>
  <path d="M238,88 L238,228" style="fill:none;stroke:var(--amber);stroke-dasharray:3 3"/>
  <line x1="40" y1="140" x2="560" y2="140" style="stroke:var(--line)"/>
  <circle cx="478" cy="140" r="6" style="fill:var(--teal)"/>
  <text x="466" y="145" text-anchor="end" font-size="13"><tspan font-weight="700" style="fill:var(--teal)">DataNode</tspan> · 落盘到 105</text>
  <line x1="40" y1="184" x2="560" y2="184" style="stroke:var(--line)"/>
  <circle cx="398" cy="184" r="6" style="fill:var(--accent)"/>
  <text x="386" y="189" text-anchor="end" font-size="13"><tspan font-weight="700" style="fill:var(--accent-ink)">QueryNode</tspan> · 读到 104（tsafe）</text>
  <line x1="40" y1="228" x2="560" y2="228" style="stroke:var(--line)"/>
  <circle cx="238" cy="228" r="6" style="fill:var(--amber)"/>
  <text x="226" y="233" text-anchor="end" font-size="13"><tspan font-weight="700" style="fill:var(--amber)">备集群</tspan> · 重放到 102</text>
</svg>
<div class="figcap"><b>一条日志，多方按需重放</b>：同一条只追加的 WAL，DataNode／QueryNode／备集群各自记着 checkpoint、按自己的进度消费——谁也不直接调用谁。</div>
</div>
...
<div class="fig">
<svg viewBox="0 0 600 258" role="img" aria-label="an append-only log with multiple read positions">
  <text x="40" y="28" font-size="13" style="fill:var(--muted)">WAL · append-only log</text>
  <text x="516" y="28" text-anchor="end" font-size="12.5" font-weight="700" style="fill:var(--accent-ink)">Proxy appends →</text>
  <rect x="40" y="42" width="76" height="46" rx="7" style="fill:var(--accent-soft);stroke:var(--accent)"/>
  <text x="78" y="71" text-anchor="middle" font-size="13.5" class="mono" style="fill:var(--accent-ink)">TT100</text>
  <rect x="120" y="42" width="76" height="46" rx="7" style="fill:var(--accent-soft);stroke:var(--accent)"/>
  <text x="158" y="71" text-anchor="middle" font-size="13.5" class="mono" style="fill:var(--accent-ink)">101</text>
  ...
  <line x1="40" y1="140" x2="560" y2="140" style="stroke:var(--line)"/>
  <circle cx="478" cy="140" r="6" style="fill:var(--teal)"/>
  <text x="466" y="145" text-anchor="end" font-size="13"><tspan font-weight="700" style="fill:var(--teal)">DataNode</tspan> · flushed to 105</text>
  <line x1="40" y1="184" x2="560" y2="184" style="stroke:var(--line)"/>
  <circle cx="398" cy="184" r="6" style="fill:var(--accent)"/>
  <text x="386" y="189" text-anchor="end" font-size="13"><tspan font-weight="700" style="fill:var(--accent-ink)">QueryNode</tspan> · read to 104 (tsafe)</text>
  <line x1="40" y1="228" x2="560" y2="228" style="stroke:var(--line)"/>
  <circle cx="238" cy="228" r="6" style="fill:var(--amber)"/>
  <text x="226" y="233" text-anchor="end" font-size="13"><tspan font-weight="700" style="fill:var(--amber)">replica</tspan> · replayed to 102</text>
</svg>
<div class="figcap"><b>One log, many replayers</b>: the same append-only WAL — DataNode / QueryNode / the replica each track a checkpoint and consume at their own pace, none calling another directly.</div>
</div>
...
<div class="fig">
<svg viewBox="0 0 600 232" role="img" aria-label="MVCC：用 Tg=100 决定行的可见性">
  <rect x="56" y="40" width="221" height="150" rx="6" style="fill:var(--accent-soft);opacity:.45"/>
  <text x="62" y="55" font-size="11.5" style="fill:var(--accent-ink)">≤ Tg 的快照</text>
  <line x1="277" y1="36" x2="277" y2="190" style="stroke:var(--accent);stroke-width:1.5;stroke-dasharray:4 3"/>
  <text x="277" y="28" text-anchor="middle" font-size="12.5" font-weight="700" style="fill:var(--accent-ink)">Tg=100</text>
  <line x1="50" y1="190" x2="560" y2="190" style="stroke:var(--line)"/>
  <text x="556" y="208" text-anchor="end" font-size="11.5" style="fill:var(--faint)">时间戳 ts →</text>
  <text x="32" y="84" font-size="13" font-weight="700">A</text>
  <circle cx="140" cy="80" r="7" style="fill:var(--accent)"/>
  <text x="140" y="101" text-anchor="middle" font-size="11" style="fill:var(--muted)">插入@80</text>
  <text x="470" y="84" font-size="12.5" font-weight="700" style="fill:var(--teal)">可见 ✓</text>
  <text x="32" y="128" font-size="13" font-weight="700">B</text>
  <circle cx="140" cy="124" r="7" style="fill:var(--accent);opacity:.38"/>
  <text x="243" y="129" text-anchor="middle" font-size="15" font-weight="700" style="fill:var(--red)">✗</text>
  <text x="243" y="146" text-anchor="middle" font-size="11" style="fill:var(--muted)">删除@95</text>
  <text x="470" y="125" font-size="12.5" font-weight="700" style="fill:var(--faint)">不可见</text>
  <text x="470" y="140" font-size="10.5" style="fill:var(--faint)">墓碑 ≤ Tg</text>
  <text x="32" y="172" font-size="13" font-weight="700">C</text>
  <circle cx="415" cy="168" r="7" style="fill:var(--muted);opacity:.5"/>
  <text x="415" y="189" text-anchor="middle" font-size="11" style="fill:var(--muted)">插入@120</text>
  <text x="470" y="169" font-size="12.5" font-weight="700" style="fill:var(--faint)">不可见</text>
  <text x="470" y="184" font-size="10.5" style="fill:var(--faint)">120 &gt; Tg</text>
</svg>
<div class="figcap"><b>一次读取 Tg=100 看到的快照</b>：A（插入@80）可见；B 被 @95 的墓碑删除（≤Tg）故不可见；C（插入@120）在 Tg 之后、尚不可见。可见性只是<b>一次时间戳比较</b>，无需加锁。</div>
</div>
...
<div class="fig">
<svg viewBox="0 0 600 232" role="img" aria-label="MVCC: Tg=100 decides each row's visibility">
  <rect x="56" y="40" width="221" height="150" rx="6" style="fill:var(--accent-soft);opacity:.45"/>
  <text x="62" y="55" font-size="11.5" style="fill:var(--accent-ink)">snapshot ≤ Tg</text>
  <line x1="277" y1="36" x2="277" y2="190" style="stroke:var(--accent);stroke-width:1.5;stroke-dasharray:4 3"/>
  <text x="277" y="28" text-anchor="middle" font-size="12.5" font-weight="700" style="fill:var(--accent-ink)">Tg=100</text>
  <line x1="50" y1="190" x2="560" y2="190" style="stroke:var(--line)"/>
  <text x="556" y="208" text-anchor="end" font-size="11.5" style="fill:var(--faint)">timestamp ts →</text>
  <text x="32" y="84" font-size="13" font-weight="700">A</text>
  <circle cx="140" cy="80" r="7" style="fill:var(--accent)"/>
  <text x="140" y="101" text-anchor="middle" font-size="11" style="fill:var(--muted)">insert@80</text>
  <text x="470" y="84" font-size="12.5" font-weight="700" style="fill:var(--teal)">visible ✓</text>
  <text x="32" y="128" font-size="13" font-weight="700">B</text>
  <circle cx="140" cy="124" r="7" style="fill:var(--accent);opacity:.38"/>
  <text x="243" y="129" text-anchor="middle" font-size="15" font-weight="700" style="fill:var(--red)">✗</text>
  <text x="243" y="146" text-anchor="middle" font-size="11" style="fill:var(--muted)">delete@95</text>
  <text x="470" y="125" font-size="12.5" font-weight="700" style="fill:var(--faint)">invisible</text>
  <text x="470" y="140" font-size="10.5" style="fill:var(--faint)">tombstone ≤ Tg</text>
  <text x="32" y="172" font-size="13" font-weight="700">C</text>
  <circle cx="415" cy="168" r="7" style="fill:var(--muted);opacity:.5"/>
  <text x="415" y="189" text-anchor="middle" font-size="11" style="fill:var(--muted)">insert@120</text>
  <text x="470" y="169" font-size="12.5" font-weight="700" style="fill:var(--faint)">invisible</text>
  <text x="470" y="184" font-size="10.5" style="fill:var(--faint)">120 &gt; Tg</text>
</svg>
<div class="figcap"><b>The snapshot one read at Tg=100 sees</b>: A (insert@80) is visible; B is deleted by the @95 tombstone (≤Tg) so invisible; C (insert@120) is past Tg, not yet visible. Visibility is just <b>one timestamp comparison</b> — no locks.</div>
</div>
...
<div class="fig">
<svg viewBox="0 0 600 268" role="img" aria-label="存算分离：节点无状态，挂了从对象存储重载">
  <rect x="40" y="20" width="520" height="38" rx="9" style="fill:var(--panel-2);stroke:var(--line)"/>
  <text x="300" y="44" text-anchor="middle" font-size="13" font-weight="700">控制面 · etcd（元数据 / 段分配 / 谁活着）</text>
  <rect x="56" y="100" width="150" height="52" rx="9" style="fill:var(--panel);stroke:var(--accent)"/>
  <text x="131" y="122" text-anchor="middle" font-size="12.5" font-weight="700" style="fill:var(--accent-ink)">QueryNode A</text>
  <text x="131" y="140" text-anchor="middle" font-size="11" style="fill:var(--muted)">持有 seg5,6</text>
  <rect x="225" y="100" width="150" height="52" rx="9" style="fill:var(--red-soft);stroke:var(--red);stroke-dasharray:4 3"/>
  <text x="300" y="122" text-anchor="middle" font-size="12.5" font-weight="700" style="fill:var(--red)">QueryNode B ✗ 宕机</text>
  <text x="300" y="140" text-anchor="middle" font-size="11" style="fill:var(--muted)">曾持有 seg7</text>
  <rect x="394" y="100" width="150" height="52" rx="9" style="fill:var(--teal-soft);stroke:var(--teal)"/>
  <text x="469" y="122" text-anchor="middle" font-size="12.5" font-weight="700" style="fill:var(--teal)">QueryNode C（新）</text>
  <text x="469" y="140" text-anchor="middle" font-size="11" style="fill:var(--muted)">加载 seg7</text>
  <rect x="40" y="208" width="520" height="46" rx="9" style="fill:var(--accent-soft);stroke:var(--accent)"/>
  <text x="300" y="236" text-anchor="middle" font-size="12.5" font-weight="700" style="fill:var(--accent-ink)">对象存储 · binlog + 索引（seg5　seg6　seg7　…）</text>
  <path d="M469,58 L469,93" style="fill:none;stroke:var(--accent);stroke-dasharray:4 3"/>
  <path d="M465,90 L473,90 L469,98 Z" style="fill:var(--accent)"/>
  <text x="478" y="80" font-size="10.5" style="fill:var(--accent-ink)">把 seg7 派给 C</text>
  <path d="M469,208 L469,159" style="fill:none;stroke:var(--teal)"/>
  <path d="M465,162 L473,162 L469,154 Z" style="fill:var(--teal)"/>
  <text x="478" y="188" font-size="10.5" style="fill:var(--teal)">C 从存储重载</text>
  <path d="M375,126 L392,126" style="fill:none;stroke:var(--faint);stroke-dasharray:2 2"/>
</svg>
<div class="figcap"><b>无状态节点的故障转移</b>：B 宕机后，控制面（QueryCoord）把它的 seg7 重新分配给新节点 C，C 直接从对象存储重载——<b>秒级恢复、一个字节不丢</b>。</div>
</div>
...
<div class="fig">
<svg viewBox="0 0 600 268" role="img" aria-label="storage-compute separation: stateless nodes reload from object storage">
  <rect x="40" y="20" width="520" height="38" rx="9" style="fill:var(--panel-2);stroke:var(--line)"/>
  <text x="300" y="44" text-anchor="middle" font-size="13" font-weight="700">control plane · etcd (metadata / assignment / liveness)</text>
  <rect x="56" y="100" width="150" height="52" rx="9" style="fill:var(--panel);stroke:var(--accent)"/>
  <text x="131" y="122" text-anchor="middle" font-size="12.5" font-weight="700" style="fill:var(--accent-ink)">QueryNode A</text>
  <text x="131" y="140" text-anchor="middle" font-size="11" style="fill:var(--muted)">holds seg5,6</text>
  <rect x="225" y="100" width="150" height="52" rx="9" style="fill:var(--red-soft);stroke:var(--red);stroke-dasharray:4 3"/>
  <text x="300" y="122" text-anchor="middle" font-size="12.5" font-weight="700" style="fill:var(--red)">QueryNode B ✗ dead</text>
  <text x="300" y="140" text-anchor="middle" font-size="11" style="fill:var(--muted)">had held seg7</text>
  <rect x="394" y="100" width="150" height="52" rx="9" style="fill:var(--teal-soft);stroke:var(--teal)"/>
  <text x="469" y="122" text-anchor="middle" font-size="12.5" font-weight="700" style="fill:var(--teal)">QueryNode C (new)</text>
  <text x="469" y="140" text-anchor="middle" font-size="11" style="fill:var(--muted)">loads seg7</text>
  <rect x="40" y="208" width="520" height="46" rx="9" style="fill:var(--accent-soft);stroke:var(--accent)"/>
  <text x="300" y="236" text-anchor="middle" font-size="12.5" font-weight="700" style="fill:var(--accent-ink)">object storage · binlog + indexes (seg5　seg6　seg7　…)</text>
  <path d="M469,58 L469,93" style="fill:none;stroke:var(--accent);stroke-dasharray:4 3"/>
  <path d="M465,90 L473,90 L469,98 Z" style="fill:var(--accent)"/>
  <text x="478" y="80" font-size="10.5" style="fill:var(--accent-ink)">assign seg7 → C</text>
  <path d="M469,208 L469,159" style="fill:none;stroke:var(--teal)"/>
  <path d="M465,162 L473,162 L469,154 Z" style="fill:var(--teal)"/>
  <text x="478" y="188" font-size="10.5" style="fill:var(--teal)">C reloads it</text>
  <path d="M375,126 L392,126" style="fill:none;stroke:var(--faint);stroke-dasharray:2 2"/>
</svg>
<div class="figcap"><b>Failover of stateless nodes</b>: when B dies, the control plane (QueryCoord) reassigns its seg7 to the new node C, which reloads it straight from object storage — <b>recovery in seconds, not a byte lost</b>.</div>
</div>
...
<div class="fig">
<svg viewBox="0 0 600 268" role="img" aria-label="扇出—归并：段 topK 逐层汇聚成全局 topK">
  <g style="stroke:var(--accent);opacity:.45;fill:none">
    <path d="M65,214 L110,170"/><path d="M155,214 L110,170"/>
    <path d="M245,214 L290,170"/><path d="M335,214 L290,170"/>
    <path d="M425,214 L470,170"/><path d="M515,214 L470,170"/>
    <path d="M110,132 L290,86"/><path d="M290,132 L290,86"/><path d="M470,132 L290,86"/>
  </g>
  <rect x="205" y="48" width="170" height="38" rx="9" style="fill:var(--accent);stroke:var(--accent)"/>
  <text x="290" y="72" text-anchor="middle" font-size="13" font-weight="700" style="fill:#fff">Proxy · 全局 topK</text>
  <rect x="55" y="132" width="110" height="38" rx="8" style="fill:var(--accent-soft);stroke:var(--accent)"/>
  <text x="110" y="156" text-anchor="middle" font-size="11.5" style="fill:var(--accent-ink)">分片 topK</text>
  <rect x="235" y="132" width="110" height="38" rx="8" style="fill:var(--accent-soft);stroke:var(--accent)"/>
  <text x="290" y="156" text-anchor="middle" font-size="11.5" style="fill:var(--accent-ink)">分片 topK</text>
  <rect x="415" y="132" width="110" height="38" rx="8" style="fill:var(--accent-soft);stroke:var(--accent)"/>
  <text x="470" y="156" text-anchor="middle" font-size="11.5" style="fill:var(--accent-ink)">分片 topK</text>
  <rect x="30" y="214" width="70" height="34" rx="7" style="fill:var(--panel-2);stroke:var(--line)"/>
  <text x="65" y="235" text-anchor="middle" font-size="11" style="fill:var(--muted)">段 topK</text>
  <rect x="120" y="214" width="70" height="34" rx="7" style="fill:var(--panel-2);stroke:var(--line)"/>
  <text x="155" y="235" text-anchor="middle" font-size="11" style="fill:var(--muted)">段 topK</text>
  <rect x="210" y="214" width="70" height="34" rx="7" style="fill:var(--panel-2);stroke:var(--line)"/>
  <text x="245" y="235" text-anchor="middle" font-size="11" style="fill:var(--muted)">段 topK</text>
  <rect x="300" y="214" width="70" height="34" rx="7" style="fill:var(--panel-2);stroke:var(--line)"/>
  <text x="335" y="235" text-anchor="middle" font-size="11" style="fill:var(--muted)">段 topK</text>
  <rect x="390" y="214" width="70" height="34" rx="7" style="fill:var(--panel-2);stroke:var(--line)"/>
  <text x="425" y="235" text-anchor="middle" font-size="11" style="fill:var(--muted)">段 topK</text>
  <rect x="480" y="214" width="70" height="34" rx="7" style="fill:var(--panel-2);stroke:var(--line)"/>
  <text x="515" y="235" text-anchor="middle" font-size="11" style="fill:var(--muted)">段 topK</text>
  <text x="372" y="112" font-size="10.5" style="fill:var(--faint)">每层只交 K 个 ↑</text>
</svg>
<div class="figcap"><b>扇出—归并的收敛形状</b>：每个段先算<b>段内 topK</b>，delegator 归并出<b>分片 topK</b>，Proxy 再归并出<b>全局 topK</b>。每层只上交 K 个候选——底下可有上亿向量，<b>网络上只流动 K 量级</b>。</div>
</div>
...
<div class="fig">
<svg viewBox="0 0 600 268" role="img" aria-label="scatter-gather: segment topKs converge into a global topK">
  <g style="stroke:var(--accent);opacity:.45;fill:none">
    <path d="M65,214 L110,170"/><path d="M155,214 L110,170"/>
    <path d="M245,214 L290,170"/><path d="M335,214 L290,170"/>
    <path d="M425,214 L470,170"/><path d="M515,214 L470,170"/>
  ...
  <rect x="205" y="48" width="170" height="38" rx="9" style="fill:var(--accent);stroke:var(--accent)"/>
  <text x="290" y="72" text-anchor="middle" font-size="13" font-weight="700" style="fill:#fff">Proxy · global topK</text>
  <rect x="55" y="132" width="110" height="38" rx="8" style="fill:var(--accent-soft);stroke:var(--accent)"/>
  <text x="110" y="156" text-anchor="middle" font-size="11.5" style="fill:var(--accent-ink)">shard topK</text>
  <rect x="235" y="132" width="110" height="38" rx="8" style="fill:var(--accent-soft);stroke:var(--accent)"/>
  <text x="290" y="156" text-anchor="middle" font-size="11.5" style="fill:var(--accent-ink)">shard topK</text>
  <rect x="415" y="132" width="110" height="38" rx="8" style="fill:var(--accent-soft);stroke:var(--accent)"/>
  <text x="470" y="156" text-anchor="middle" font-size="11.5" style="fill:var(--accent-ink)">shard topK</text>
  <rect x="30" y="214" width="70" height="34" rx="7" style="fill:var(--panel-2);stroke:var(--line)"/>
  <text x="65" y="235" text-anchor="middle" font-size="11" style="fill:var(--muted)">seg topK</text>
  <rect x="120" y="214" width="70" height="34" rx="7" style="fill:var(--panel-2);stroke:var(--line)"/>
  <text x="155" y="235" text-anchor="middle" font-size="11" style="fill:var(--muted)">seg topK</text>
  <rect x="210" y="214" width="70" height="34" rx="7" style="fill:var(--panel-2);stroke:var(--line)"/>
  <text x="245" y="235" text-anchor="middle" font-size="11" style="fill:var(--muted)">seg topK</text>
  <rect x="300" y="214" width="70" height="34" rx="7" style="fill:var(--panel-2);stroke:var(--line)"/>
  <text x="335" y="235" text-anchor="middle" font-size="11" style="fill:var(--muted)">seg topK</text>
  <rect x="390" y="214" width="70" height="34" rx="7" style="fill:var(--panel-2);stroke:var(--line)"/>
  <text x="425" y="235" text-anchor="middle" font-size="11" style="fill:var(--muted)">seg topK</text>
  <rect x="480" y="214" width="70" height="34" rx="7" style="fill:var(--panel-2);stroke:var(--line)"/>
  <text x="515" y="235" text-anchor="middle" font-size="11" style="fill:var(--muted)">seg topK</text>
  <text x="360" y="112" font-size="10.5" style="fill:var(--faint)">only K per level ↑</text>
</svg>
<div class="figcap"><b>The converging shape of scatter-gather</b>: each segment computes a <b>segment topK</b>, the delegator merges a <b>shard topK</b>, and the Proxy merges the <b>global topK</b>. Each layer passes up only K candidates — a billion vectors below, yet <b>only K-scale crosses the network</b>.</div>
</div>
...
<div class="fig">
<svg viewBox="0 0 600 224" role="img" aria-label="cgo 边界：每行一调 vs 整批一调">
  <rect x="18" y="40" width="270" height="170" rx="10" style="fill:none;stroke:var(--line)"/>
  <text x="153" y="61" text-anchor="middle" font-size="12.5" font-weight="700" style="fill:var(--red)">❌ 每行一调</text>
  <text x="32" y="98" font-size="11" style="fill:var(--muted)">Go</text>
  <text x="32" y="190" font-size="11" style="fill:var(--muted)">C++ · segcore</text>
  <line x1="28" y1="138" x2="278" y2="138" style="stroke:var(--muted);stroke-dasharray:4 3"/>
  <text x="272" y="133" text-anchor="end" font-size="10" style="fill:var(--faint)">cgo 边界</text>
  <g style="stroke:var(--amber);fill:none">
    <path d="M70,104 L70,172"/><path d="M105,104 L105,172"/><path d="M140,104 L140,172"/>
    <path d="M175,104 L175,172"/><path d="M210,104 L210,172"/><path d="M245,104 L245,172"/>
  </g>
  <g style="fill:var(--amber)">
    <path d="M66,168 L74,168 L70,176 Z"/><path d="M101,168 L109,168 L105,176 Z"/><path d="M136,168 L144,168 L140,176 Z"/>
    <path d="M171,168 L179,168 L175,176 Z"/><path d="M206,168 L214,168 L210,176 Z"/><path d="M241,168 L249,168 L245,176 Z"/>
  </g>
  <g style="fill:var(--red)">
    <circle cx="70" cy="138" r="3"/><circle cx="105" cy="138" r="3"/><circle cx="140" cy="138" r="3"/>
    <circle cx="175" cy="138" r="3"/><circle cx="210" cy="138" r="3"/><circle cx="245" cy="138" r="3"/>
  </g>
  <text x="153" y="204" text-anchor="middle" font-size="10.5" style="fill:var(--muted)">N 行 → N 次过桥，固定开销 ×N</text>
  <rect x="312" y="40" width="270" height="170" rx="10" style="fill:none;stroke:var(--teal)"/>
  <text x="447" y="61" text-anchor="middle" font-size="12.5" font-weight="700" style="fill:var(--teal)">✅ 整批一调 · 零拷贝</text>
  <text x="326" y="98" font-size="11" style="fill:var(--muted)">Go</text>
  <text x="326" y="190" font-size="11" style="fill:var(--muted)">C++ · segcore</text>
  <line x1="322" y1="138" x2="572" y2="138" style="stroke:var(--muted);stroke-dasharray:4 3"/>
  <text x="566" y="133" text-anchor="end" font-size="10" style="fill:var(--faint)">cgo 边界</text>
  <rect x="412" y="100" width="70" height="38" rx="8" style="fill:var(--teal-soft);stroke:var(--teal)"/>
  <text x="447" y="124" text-anchor="middle" font-size="11.5" style="fill:var(--teal)">一整批 nq</text>
  <path d="M447,138 L447,171" style="stroke:var(--teal);stroke-width:11;fill:none"/>
  <path d="M433,169 L461,169 L447,182 Z" style="fill:var(--teal)"/>
  <circle cx="447" cy="138" r="3.5" style="fill:var(--red)"/>
  <text x="447" y="204" text-anchor="middle" font-size="10.5" style="fill:var(--muted)">N 行 → 1 次过桥，开销摊薄</text>
</svg>
<div class="figcap"><b>cgo 是有固定开销的边界</b>。左：每行一次调用 → 过桥 N 次、开销 ×N（红点＝每次的固定成本）；右：把整段检索打包成<b>一次粗粒度、零拷贝</b>的调用 → 只过桥一次，开销被摊薄。<b>批越大越划算</b>。</div>
</div>
...
<div class="fig">
<svg viewBox="0 0 600 224" role="img" aria-label="cgo boundary: one call per row vs one batched call">
  <rect x="18" y="40" width="270" height="170" rx="10" style="fill:none;stroke:var(--line)"/>
  <text x="153" y="61" text-anchor="middle" font-size="12.5" font-weight="700" style="fill:var(--red)">❌ one call per row</text>
  <text x="32" y="98" font-size="11" style="fill:var(--muted)">Go</text>
  <text x="32" y="190" font-size="11" style="fill:var(--muted)">C++ · segcore</text>
  <line x1="28" y1="138" x2="278" y2="138" style="stroke:var(--muted);stroke-dasharray:4 3"/>
  <text x="272" y="133" text-anchor="end" font-size="10" style="fill:var(--faint)">cgo boundary</text>
  <g style="stroke:var(--amber);fill:none">
    <path d="M70,104 L70,172"/><path d="M105,104 L105,172"/><path d="M140,104 L140,172"/>
    <path d="M175,104 L175,172"/><path d="M210,104 L210,172"/><path d="M245,104 L245,172"/>
  </g>
  ...
  <text x="153" y="204" text-anchor="middle" font-size="10.5" style="fill:var(--muted)">N rows → N crossings, fixed cost ×N</text>
  <rect x="312" y="40" width="270" height="170" rx="10" style="fill:none;stroke:var(--teal)"/>
  <text x="447" y="61" text-anchor="middle" font-size="12.5" font-weight="700" style="fill:var(--teal)">✅ one batched call · zero-copy</text>
  <text x="326" y="98" font-size="11" style="fill:var(--muted)">Go</text>
  <text x="326" y="190" font-size="11" style="fill:var(--muted)">C++ · segcore</text>
  <line x1="322" y1="138" x2="572" y2="138" style="stroke:var(--muted);stroke-dasharray:4 3"/>
  <text x="566" y="133" text-anchor="end" font-size="10" style="fill:var(--faint)">cgo boundary</text>
  <rect x="412" y="100" width="70" height="38" rx="8" style="fill:var(--teal-soft);stroke:var(--teal)"/>
  <text x="447" y="124" text-anchor="middle" font-size="11.5" style="fill:var(--teal)">one batch (nq)</text>
  <path d="M447,138 L447,171" style="stroke:var(--teal);stroke-width:11;fill:none"/>
  <path d="M433,169 L461,169 L447,182 Z" style="fill:var(--teal)"/>
  <circle cx="447" cy="138" r="3.5" style="fill:var(--red)"/>
  <text x="447" y="204" text-anchor="middle" font-size="10.5" style="fill:var(--muted)">N rows → 1 crossing, cost amortized</text>
</svg>
<div class="figcap"><b>cgo is a boundary with a fixed per-call cost</b>. Left: one call per row → N crossings, cost ×N (red dots = the fixed cost each time); right: pack a whole segment's search into <b>one coarse-grained, zero-copy</b> call → one crossing, the cost amortized. <b>The bigger the batch, the better.</b></div>
</div>
...
<div class="fig">
<svg viewBox="0 0 580 222" role="img" aria-label="对账：比对目标态与实际态，纠正偏差">
  <text x="150" y="22" text-anchor="middle" font-size="12" font-weight="700" style="fill:var(--muted)">目标态（声明）</text>
  <text x="430" y="22" text-anchor="middle" font-size="12" font-weight="700" style="fill:var(--muted)">实际态（观测）</text>
  <rect x="30" y="32" width="240" height="112" rx="10" style="fill:var(--panel-2);stroke:var(--line)"/>
  <rect x="310" y="32" width="240" height="112" rx="10" style="fill:var(--panel-2);stroke:var(--line)"/>
  <text x="58" y="64" font-size="12.5" class="mono">seg5 → A</text>
  <text x="58" y="94" font-size="12.5" class="mono">seg6 → A</text>
  <text x="58" y="124" font-size="12.5" class="mono">seg7 → B</text>
  <text x="338" y="64" font-size="12.5" class="mono">seg5 → A ✓</text>
  <text x="338" y="94" font-size="12.5" class="mono">seg6 → A ✓</text>
  <rect x="324" y="108" width="212" height="26" rx="6" style="fill:var(--red-soft);stroke:var(--red)"/>
  <text x="338" y="125" font-size="12.5" class="mono" style="fill:var(--red)">seg7 → ✗　B 宕机</text>
  <text x="290" y="92" text-anchor="middle" font-size="20" font-weight="700" style="fill:var(--amber)">≠</text>
  <rect x="30" y="164" width="520" height="42" rx="10" style="fill:var(--teal-soft);stroke:var(--teal)"/>
  <text x="290" y="190" text-anchor="middle" font-size="12.5" font-weight="700" style="fill:var(--teal)">对账：发现 seg7 偏离目标 → 重派给 C、从对象存储重载</text>
  <path d="M430,134 L430,162" style="fill:none;stroke:var(--amber)"/>
  <path d="M426,158 L434,158 L430,164 Z" style="fill:var(--amber)"/>
  <path d="M472,164 L472,138" style="fill:none;stroke:var(--teal)"/>
  <path d="M468,142 L476,142 L472,134 Z" style="fill:var(--teal)"/>
  <text x="486" y="153" font-size="9.5" style="fill:var(--teal)">纠正</text>
</svg>
<div class="figcap"><b>状态驱动的自愈</b>：协调者持续比对「目标态」（每个段都该被加载）与「实际态」（B 挂了、seg7 无人加载），一旦 ≠ 就对账纠正——把 seg7 重派给 C、从对象存储重载。<b>不问中间出过什么故障，只要持续对账，终会收敛到正确状态。</b></div>
</div>
...
<div class="fig">
<svg viewBox="0 0 580 222" role="img" aria-label="reconcile: compare target vs actual, fix the gap">
  <text x="150" y="22" text-anchor="middle" font-size="12" font-weight="700" style="fill:var(--muted)">declared (target)</text>
  <text x="430" y="22" text-anchor="middle" font-size="12" font-weight="700" style="fill:var(--muted)">observed (actual)</text>
  <rect x="30" y="32" width="240" height="112" rx="10" style="fill:var(--panel-2);stroke:var(--line)"/>
  <rect x="310" y="32" width="240" height="112" rx="10" style="fill:var(--panel-2);stroke:var(--line)"/>
  <text x="58" y="64" font-size="12.5" class="mono">seg5 → A</text>
  <text x="58" y="94" font-size="12.5" class="mono">seg6 → A</text>
  ...
  <text x="338" y="94" font-size="12.5" class="mono">seg6 → A ✓</text>
  <rect x="324" y="108" width="212" height="26" rx="6" style="fill:var(--red-soft);stroke:var(--red)"/>
  <text x="338" y="125" font-size="12.5" class="mono" style="fill:var(--red)">seg7 → ✗　B dead</text>
  <text x="290" y="92" text-anchor="middle" font-size="20" font-weight="700" style="fill:var(--amber)">≠</text>
  <rect x="30" y="164" width="520" height="42" rx="10" style="fill:var(--teal-soft);stroke:var(--teal)"/>
  <text x="290" y="190" text-anchor="middle" font-size="12" font-weight="700" style="fill:var(--teal)">reconcile: seg7 diverged → reassign to C, reload from object storage</text>
  <path d="M430,134 L430,162" style="fill:none;stroke:var(--amber)"/>
  <path d="M426,158 L434,158 L430,164 Z" style="fill:var(--amber)"/>
  <path d="M472,164 L472,138" style="fill:none;stroke:var(--teal)"/>
  <path d="M468,142 L476,142 L472,134 Z" style="fill:var(--teal)"/>
  <text x="486" y="153" font-size="9.5" style="fill:var(--teal)">fix</text>
</svg>
<div class="figcap"><b>State-driven self-healing</b>: coordinators continuously compare the "target" (every segment should be loaded) with the "actual" (B died, seg7 unloaded); on any ≠, reconcile fixes it — reassign seg7 to C, reload from object storage. <b>It never asks what failure happened in between; as long as it keeps reconciling, it converges to the correct state.</b></div>
</div>

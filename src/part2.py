...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="三种度量的几何含义：L2 是两点直线距离，COSINE 是夹角，IP 同时含方向与模长">
    <line x1="110" y1="244" x2="440" y2="244" style="stroke:var(--line);stroke-width:1.5"/>
    <line x1="110" y1="244" x2="110" y2="64" style="stroke:var(--line);stroke-width:1.5"/>
    <text x="446" y="248" style="fill:var(--faint)">x</text>
    <text x="92" y="60" style="fill:var(--faint)">y</text>
    <line x1="110" y1="244" x2="360" y2="96" style="stroke:var(--accent);stroke-width:2.5"/>
    <path d="M360,96 l-2,12 l11,-6 z" style="fill:var(--accent)"/>
    <text x="366" y="92" style="fill:var(--accent-ink);font-weight:700">u</text>
    <line x1="110" y1="244" x2="420" y2="182" style="stroke:var(--accent);stroke-width:2.5"/>
    <path d="M420,182 l-11,-2 l5,11 z" style="fill:var(--accent)"/>
    <text x="428" y="186" style="fill:var(--accent-ink);font-weight:700">v</text>
    <line x1="360" y1="96" x2="420" y2="182" style="stroke:var(--amber);stroke-width:2;stroke-dasharray:5 4"/>
    <text x="398" y="128" style="fill:var(--amber);font-weight:700">L2</text>
...
<div class="cellgroup">
  ...
  <div class="cells"><span class="lab">IP</span><span class="cell q">0.90·0.88</span><span class="sep">+</span><span class="cell q">0.10·0.12</span><span class="sep">+</span><span class="cell q">0.80·0.79</span><span class="sep">=</span><span class="cell scale">1.44 越大越像</span></div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="把 a=[3,4]、b=[4,3] 画在坐标系里，三把尺子各给一个数：L2≈1.41、IP=24、COSINE=0.96">
    <line x1="90" y1="250" x2="360" y2="250" style="stroke:var(--line);stroke-width:1.5"/>
    <line x1="90" y1="250" x2="90" y2="70" style="stroke:var(--line);stroke-width:1.5"/>
    <text x="78" y="264" style="fill:var(--faint)">O</text>
    <text x="96" y="84" style="fill:var(--muted)">|a| = |b| = 5</text>
    <line x1="90" y1="250" x2="198" y2="106" style="stroke:var(--accent);stroke-width:2.5"/>
    <path d="M198,106 l-2,12 l11,-6 z" style="fill:var(--accent)"/>
    <text x="150" y="100" class="mono" style="fill:var(--accent-ink);font-weight:700">a=[3,4]</text>
    <line x1="90" y1="250" x2="234" y2="142" style="stroke:var(--blue);stroke-width:2.5"/>
    <path d="M234,142 l-11,-1 l4,11 z" style="fill:var(--blue)"/>
    <text x="240" y="150" class="mono" style="fill:var(--blue);font-weight:700">b=[4,3]</text>
    <line x1="198" y1="106" x2="234" y2="142" style="stroke:var(--amber);stroke-width:2;stroke-dasharray:5 4"/>
    <text x="236" y="116" style="fill:var(--amber);font-weight:700">L2=√2</text>
    <path d="M128,199 A64,64 0 0 1 141,212" style="fill:none;stroke:var(--purple);stroke-width:2.5"/>
    <text x="116" y="190" style="fill:var(--purple);font-weight:700">θ</text>
    <text x="388" y="92" style="fill:var(--muted)">同两条向量 → 三个数</text>
    <rect x="388" y="104" width="354" height="52" rx="9" style="fill:var(--panel-2);stroke:var(--amber);stroke-width:1.5"/>
    <text x="406" y="128" class="mono" style="fill:var(--ink);font-weight:700">L2 = √2 ≈ 1.41</text>
    <text x="406" y="147" style="fill:var(--muted)">距离 · 越小越像</text>
    <rect x="388" y="164" width="354" height="52" rx="9" style="fill:var(--panel-2);stroke:var(--teal);stroke-width:1.5"/>
    <text x="406" y="188" class="mono" style="fill:var(--ink);font-weight:700">IP = 3·4 + 4·3 = 24</text>
    <text x="406" y="207" style="fill:var(--muted)">相似度 · 越大越像</text>
    <rect x="388" y="224" width="354" height="52" rx="9" style="fill:var(--panel-2);stroke:var(--purple);stroke-width:1.5"/>
    <text x="406" y="248" class="mono" style="fill:var(--ink);font-weight:700">COSINE = 24 ÷ 25 = 0.96</text>
    <text x="406" y="267" style="fill:var(--muted)">夹角 · 越接近 1 越像</text>
  </svg>
  <div class="figcap"><b>同两条向量，三把尺子各得什么</b>：<span class="mono">a=[3,4]</span>、<span class="mono">b=[4,3]</span> 隔着一小段距离（<b>L2≈1.41</b>），方向却很接近（<b>COSINE=0.96</b>）——<b>选错尺子，"像不像"的结论可能完全拧</b>。</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="Geometric meaning of three metrics: L2 is the straight-line distance, COSINE is the angle, IP folds in both direction and magnitude">
    <line x1="110" y1="244" x2="440" y2="244" style="stroke:var(--line);stroke-width:1.5"/>
    <line x1="110" y1="244" x2="110" y2="64" style="stroke:var(--line);stroke-width:1.5"/>
    <text x="446" y="248" style="fill:var(--faint)">x</text>
    <text x="92" y="60" style="fill:var(--faint)">y</text>
...
<div class="cellgroup">
  ...
  <div class="cells"><span class="lab">q</span><span class="cell hl">0.90</span><span class="cell hl">0.10</span><span class="cell hl">0.80</span></div>
  <div class="cells"><span class="lab">v</span><span class="cell">0.88</span><span class="cell">0.12</span><span class="cell">0.79</span></div>
  <div class="cells"><span class="lab">IP</span><span class="cell q">0.90·0.88</span><span class="sep">+</span><span class="cell q">0.10·0.12</span><span class="sep">+</span><span class="cell q">0.80·0.79</span><span class="sep">=</span><span class="cell scale">1.44 bigger = closer</span></div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="Plotting a=[3,4] and b=[4,3]; the three rulers each give a number: L2 about 1.41, IP 24, COSINE 0.96">
    <line x1="90" y1="250" x2="360" y2="250" style="stroke:var(--line);stroke-width:1.5"/>
    <line x1="90" y1="250" x2="90" y2="70" style="stroke:var(--line);stroke-width:1.5"/>
    <text x="78" y="264" style="fill:var(--faint)">O</text>
    <text x="96" y="84" style="fill:var(--muted)">|a| = |b| = 5</text>
    ...
    <path d="M128,199 A64,64 0 0 1 141,212" style="fill:none;stroke:var(--purple);stroke-width:2.5"/>
    <text x="116" y="190" style="fill:var(--purple);font-weight:700">θ</text>
    <text x="388" y="92" style="fill:var(--muted)">same two vectors → three numbers</text>
    <rect x="388" y="104" width="354" height="52" rx="9" style="fill:var(--panel-2);stroke:var(--amber);stroke-width:1.5"/>
    <text x="406" y="128" class="mono" style="fill:var(--ink);font-weight:700">L2 = √2 ≈ 1.41</text>
    <text x="406" y="147" style="fill:var(--muted)">distance · smaller = closer</text>
    <rect x="388" y="164" width="354" height="52" rx="9" style="fill:var(--panel-2);stroke:var(--teal);stroke-width:1.5"/>
    <text x="406" y="188" class="mono" style="fill:var(--ink);font-weight:700">IP = 3·4 + 4·3 = 24</text>
    <text x="406" y="207" style="fill:var(--muted)">similarity · larger = closer</text>
    <rect x="388" y="224" width="354" height="52" rx="9" style="fill:var(--panel-2);stroke:var(--purple);stroke-width:1.5"/>
    <text x="406" y="248" class="mono" style="fill:var(--ink);font-weight:700">COSINE = 24 ÷ 25 = 0.96</text>
    <text x="406" y="267" style="fill:var(--muted)">angle · closer to 1 = closer</text>
  </svg>
  <div class="figcap"><b>Same two vectors, what each ruler gives</b>: <span class="mono">a=[3,4]</span> and <span class="mono">b=[4,3]</span> sit a little apart (<b>L2≈1.41</b>) yet point in nearly the same direction (<b>COSINE=0.96</b>) — <b>pick the wrong ruler and the "alike?" verdict can flip</b>.</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="IVF 把向量空间聚成 6 个桶，查询只在最近的 2 个桶里精算，其余 4 桶跳过">
    <polygon points="60,56 213,56 203,168 60,158" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.2;opacity:.7"/>
    <polygon points="367,56 520,56 520,162 378,172" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.2;opacity:.7"/>
    <polygon points="60,158 203,168 193,276 60,276" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.2;opacity:.7"/>
    <polygon points="378,172 520,162 520,276 367,276" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.2;opacity:.7"/>
    <polygon points="213,56 367,56 378,172 203,168" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:2"/>
    <polygon points="203,168 378,172 367,276 193,276" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:2"/>
    <text x="84" y="150" style="fill:var(--faint)">跳过</text>
    <text x="84" y="262" style="fill:var(--faint)">跳过</text>
    <text x="478" y="150" style="fill:var(--faint)">跳过</text>
    <text x="478" y="262" style="fill:var(--faint)">跳过</text>
    <path d="M129,108 l12,0 M135,102 l0,12" style="stroke:var(--muted);stroke-width:2"/>
    <path d="M442,108 l12,0 M448,102 l0,12" style="stroke:var(--muted);stroke-width:2"/>
    <path d="M119,220 l12,0 M125,214 l0,12" style="stroke:var(--muted);stroke-width:2"/>
    <path d="M444,222 l12,0 M450,216 l0,12" style="stroke:var(--muted);stroke-width:2"/>
    <path d="M286,110 l12,0 M292,104 l0,12" style="stroke:var(--accent-ink);stroke-width:2"/>
    <path d="M279,224 l12,0 M285,218 l0,12" style="stroke:var(--accent-ink);stroke-width:2"/>
    <circle cx="270" cy="92" r="3.5" style="fill:var(--accent)"/><circle cx="318" cy="100" r="3.5" style="fill:var(--accent)"/><circle cx="248" cy="138" r="3.5" style="fill:var(--accent)"/>
    <circle cx="258" cy="206" r="3.5" style="fill:var(--accent)"/><circle cx="322" cy="214" r="3.5" style="fill:var(--accent)"/><circle cx="300" cy="252" r="3.5" style="fill:var(--accent)"/>
    <line x1="292" y1="168" x2="292" y2="116" style="stroke:var(--accent);stroke-width:1.5;stroke-dasharray:4 3"/>
    <line x1="292" y1="168" x2="286" y2="218" style="stroke:var(--accent);stroke-width:1.5;stroke-dasharray:4 3"/>
    <circle cx="292" cy="168" r="7" style="fill:var(--accent)"/>
    <circle cx="292" cy="168" r="12" style="fill:none;stroke:var(--accent);stroke-width:1.5"/>
    <text x="292" y="158" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">q</text>
    <text x="552" y="86" style="fill:var(--muted)">nlist=6 · nprobe=2</text>
    <rect x="552" y="102" width="16" height="16" rx="3" style="fill:var(--accent-soft);stroke:var(--accent)"/><text x="576" y="115" style="fill:var(--ink)">桶内精算</text>
    <rect x="552" y="132" width="16" height="16" rx="3" style="fill:var(--panel-2);stroke:var(--line)"/><text x="576" y="145" style="fill:var(--ink)">其余跳过</text>
    <path d="M554,172 l12,0 M560,166 l0,12" style="stroke:var(--muted);stroke-width:2"/><text x="576" y="177" style="fill:var(--ink)">桶中心</text>
    <circle cx="560" cy="200" r="5" style="fill:var(--accent)"/><text x="576" y="205" style="fill:var(--ink)">查询 q</text>
  </svg>
  <div class="figcap"><b>只在最近的桶里精算</b>：k-means 把全库聚成 <span class="mono">nlist=6</span> 个桶，查询 <span class="mono">q</span> 只探离它<b>最近的 nprobe=2 个桶</b>（精确比对），其余 <b>4 桶直接跳过</b>——这就是 IVF "跳过大半数据"的来历，也是 <span class="mono">nprobe</span> 调大召回更高的原因。</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="HNSW 多层图上的贪心搜索：从顶层稀疏图入口出发，逐层下沉，几跳逼近最近邻">
    <text x="18" y="76" style="fill:var(--muted)">顶层·稀疏</text>
    <text x="18" y="162" style="fill:var(--muted)">中间层</text>
    <text x="18" y="252" style="fill:var(--muted)">底层·稠密</text>
    ...
    <line x1="330" y1="80" x2="300" y2="150" style="stroke:var(--line);stroke-width:1;stroke-dasharray:3 4;opacity:.5"/>
    <line x1="440" y1="166" x2="430" y2="240" style="stroke:var(--line);stroke-width:1;stroke-dasharray:3 4;opacity:.5"/>
    <circle cx="330" cy="72" r="7" style="fill:var(--panel-2);stroke:var(--line)"/>
    <circle cx="560" cy="72" r="7" style="fill:var(--panel-2);stroke:var(--line)"/>
    <circle cx="160" cy="158" r="6" style="fill:var(--panel-2);stroke:var(--line)"/>
    <circle cx="580" cy="158" r="6" style="fill:var(--panel-2);stroke:var(--line)"/>
    <circle cx="680" cy="158" r="6" style="fill:var(--panel-2);stroke:var(--line)"/>
    <circle cx="110" cy="248" r="6" style="fill:var(--panel-2);stroke:var(--line)"/>
    <circle cx="190" cy="248" r="6" style="fill:var(--panel-2);stroke:var(--line)"/>
    <circle cx="270" cy="248" r="6" style="fill:var(--panel-2);stroke:var(--line)"/>
    <circle cx="350" cy="248" r="6" style="fill:var(--panel-2);stroke:var(--line)"/>
    <circle cx="510" cy="248" r="6" style="fill:var(--panel-2);stroke:var(--line)"/>
    <circle cx="590" cy="248" r="6" style="fill:var(--panel-2);stroke:var(--line)"/>
    <circle cx="670" cy="248" r="6" style="fill:var(--panel-2);stroke:var(--line)"/>
    <line x1="130" y1="72" x2="319" y2="72" style="stroke:var(--accent);stroke-width:3"/>
    <path d="M321,72 l-11,-5 l0,10 z" style="fill:var(--accent)"/>
    <line x1="326" y1="80" x2="304" y2="148" style="stroke:var(--accent);stroke-width:3"/>
    <path d="M302,150 l1,-12 l8,7 z" style="fill:var(--accent)"/>
    <line x1="311" y1="158" x2="429" y2="158" style="stroke:var(--accent);stroke-width:3"/>
    <path d="M431,158 l-11,-5 l0,10 z" style="fill:var(--accent)"/>
    <line x1="438" y1="166" x2="431" y2="238" style="stroke:var(--accent);stroke-width:3"/>
    <path d="M430,240 l-3,-11 l9,4 z" style="fill:var(--accent)"/>
    <circle cx="120" cy="72" r="9" style="fill:var(--accent);stroke:var(--accent)"/>
    <text x="120" y="50" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">入口</text>
    <circle cx="300" cy="158" r="7" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:2"/>
    <circle cx="440" cy="158" r="7" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:2"/>
    <circle cx="430" cy="248" r="11" style="fill:var(--teal);stroke:var(--teal)"/>
    <text x="430" y="278" text-anchor="middle" style="fill:var(--teal);font-weight:700">最近邻 ✓</text>
  </svg>
  <div class="figcap"><b>在多层图上"几跳"逼近</b>：从<b>顶层稀疏图</b>的入口大跨步出发，每步贪心跳向更近的邻居，<b>逐层下沉</b>到更密的层，最后在底层收敛到最近邻——<b>整条路径只访问全库极小一部分节点</b>。</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="IVF clusters the vector space into 6 buckets; the query refines only the 2 nearest buckets and skips the other 4">
    <polygon points="60,56 213,56 203,168 60,158" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.2;opacity:.7"/>
    <polygon points="367,56 520,56 520,162 378,172" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.2;opacity:.7"/>
    <polygon points="60,158 203,168 193,276 60,276" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.2;opacity:.7"/>
    <polygon points="378,172 520,162 520,276 367,276" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.2;opacity:.7"/>
    <polygon points="213,56 367,56 378,172 203,168" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:2"/>
    <polygon points="203,168 378,172 367,276 193,276" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:2"/>
    <text x="80" y="150" style="fill:var(--faint)">skip</text>
    <text x="80" y="262" style="fill:var(--faint)">skip</text>
    <text x="478" y="150" style="fill:var(--faint)">skip</text>
    <text x="478" y="262" style="fill:var(--faint)">skip</text>
    <path d="M129,108 l12,0 M135,102 l0,12" style="stroke:var(--muted);stroke-width:2"/>
    <path d="M442,108 l12,0 M448,102 l0,12" style="stroke:var(--muted);stroke-width:2"/>
    <path d="M119,220 l12,0 M125,214 l0,12" style="stroke:var(--muted);stroke-width:2"/>
    <path d="M444,222 l12,0 M450,216 l0,12" style="stroke:var(--muted);stroke-width:2"/>
    ...
    <text x="292" y="158" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">q</text>
    <text x="552" y="86" style="fill:var(--muted)">nlist=6 · nprobe=2</text>
    <rect x="552" y="102" width="16" height="16" rx="3" style="fill:var(--accent-soft);stroke:var(--accent)"/><text x="576" y="115" style="fill:var(--ink)">refined</text>
    <rect x="552" y="132" width="16" height="16" rx="3" style="fill:var(--panel-2);stroke:var(--line)"/><text x="576" y="145" style="fill:var(--ink)">skipped</text>
    <path d="M554,172 l12,0 M560,166 l0,12" style="stroke:var(--muted);stroke-width:2"/><text x="576" y="177" style="fill:var(--ink)">centroid</text>
    <circle cx="560" cy="200" r="5" style="fill:var(--accent)"/><text x="576" y="205" style="fill:var(--ink)">query q</text>
  </svg>
  <div class="figcap"><b>Refine only the nearest buckets</b>: k-means clusters all vectors into <span class="mono">nlist=6</span> buckets; query <span class="mono">q</span> probes only the <b>nearest nprobe=2 buckets</b> (exact compare) and <b>skips the other 4</b> — that is how IVF "skips most of the data", and why a larger <span class="mono">nprobe</span> lifts recall.</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="Greedy search on the HNSW multi-layer graph: start at an entry on the sparse top layer, descend layer by layer, reach the nearest neighbor in a few hops">
    ...
    <path d="M430,240 l-3,-11 l9,4 z" style="fill:var(--accent)"/>
    <circle cx="120" cy="72" r="9" style="fill:var(--accent);stroke:var(--accent)"/>
    <text x="120" y="50" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">entry</text>
    <circle cx="300" cy="158" r="7" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:2"/>
    <circle cx="440" cy="158" r="7" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:2"/>
    <circle cx="430" cy="248" r="11" style="fill:var(--teal);stroke:var(--teal)"/>
    <text x="430" y="278" text-anchor="middle" style="fill:var(--teal);font-weight:700">nearest ✓</text>
  </svg>
  <div class="figcap"><b>A few hops on a multi-layer graph</b>: start with a big stride from an entry on the <b>sparse top layer</b>, greedily hop toward closer neighbors, <b>descend layer by layer</b> to denser layers, and converge on the nearest neighbor at the bottom — <b>visiting only a tiny fraction of all nodes</b>.</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="集合按分区键把数据分到不同分区，分区内再切成段，段里是一行行实体；查询按分区键只搜相关分区">
    <rect x="40" y="42" width="232" height="40" rx="8" style="fill:var(--panel-2);stroke:var(--line)"/>
    <text x="156" y="67" text-anchor="middle" class="mono" style="fill:var(--ink)">row { user_id: 42, vec, … }</text>
    <line x1="272" y1="62" x2="310" y2="62" style="stroke:var(--line);stroke-width:2"/><path d="M310,62 l-11,-5 l0,10 z" style="fill:var(--line)"/>
    <rect x="312" y="42" width="150" height="40" rx="8" style="fill:var(--accent-soft);stroke:var(--accent)"/>
    <text x="387" y="67" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">hash(分区键)</text>
    <line x1="462" y1="62" x2="512" y2="62" style="stroke:var(--accent);stroke-width:2"/><path d="M512,62 l-11,-5 l0,10 z" style="fill:var(--accent)"/>
    <text x="600" y="56" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">user=42 → 分区 A</text>
    <text x="600" y="76" text-anchor="middle" style="fill:var(--muted)">查询带 user=42 只搜 A</text>
    <path d="M387,84 C387,108 218,108 218,130" style="fill:none;stroke:var(--accent);stroke-width:1.5;stroke-dasharray:5 4"/>
    <path d="M218,132 l-5,-11 l10,1 z" style="fill:var(--accent)"/>
    <rect x="40" y="104" width="680" height="168" rx="12" style="fill:none;stroke:var(--accent);stroke-width:1.5"/>
    <text x="56" y="125" style="fill:var(--accent-ink);font-weight:700">collection（集合）</text>
    <rect x="58" y="132" width="320" height="130" rx="10" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="74" y="152" style="fill:var(--accent-ink);font-weight:700">partition A · user=42</text>
    <rect x="74" y="160" width="140" height="92" rx="8" style="fill:var(--panel);stroke:var(--line)"/><text x="144" y="178" text-anchor="middle" style="fill:var(--ink)">segment</text>
    <circle cx="100" cy="206" r="4" style="fill:var(--muted)"/><circle cx="124" cy="206" r="4" style="fill:var(--muted)"/><circle cx="148" cy="206" r="4" style="fill:var(--muted)"/><circle cx="172" cy="206" r="4" style="fill:var(--muted)"/>
    <text x="144" y="240" text-anchor="middle" style="fill:var(--faint)">⊃ entities（行）</text>
    <rect x="222" y="160" width="140" height="92" rx="8" style="fill:var(--panel);stroke:var(--line)"/><text x="292" y="178" text-anchor="middle" style="fill:var(--ink)">segment</text>
    <circle cx="248" cy="206" r="4" style="fill:var(--muted)"/><circle cx="272" cy="206" r="4" style="fill:var(--muted)"/><circle cx="296" cy="206" r="4" style="fill:var(--muted)"/>
    <rect x="398" y="132" width="304" height="130" rx="10" style="fill:var(--panel-2);stroke:var(--line)"/>
    <text x="414" y="152" style="fill:var(--muted)">partition B · user=99</text>
    <rect x="414" y="160" width="132" height="92" rx="8" style="fill:var(--panel);stroke:var(--line)"/><text x="480" y="178" text-anchor="middle" style="fill:var(--muted)">segment</text>
    <rect x="554" y="160" width="132" height="92" rx="8" style="fill:var(--panel);stroke:var(--line)"/><text x="620" y="178" text-anchor="middle" style="fill:var(--muted)">segment</text>
  </svg>
  <div class="figcap"><b>逐层切小：collection ⊃ partition ⊃ segment ⊃ entity</b>：<span class="mono">hash(分区键)</span> 把每行<b>自动路由</b>到某个分区；查询带上分区键就<b>只搜对应分区</b>，先在数据层剪掉一大片无关数据。</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="A collection routes data into partitions by partition key; each partition splits into segments; segments hold rows; a query searches only the relevant partition">
    <rect x="40" y="42" width="232" height="40" rx="8" style="fill:var(--panel-2);stroke:var(--line)"/>
    <text x="156" y="67" text-anchor="middle" class="mono" style="fill:var(--ink)">row { user_id: 42, vec, … }</text>
    <line x1="272" y1="62" x2="310" y2="62" style="stroke:var(--line);stroke-width:2"/><path d="M310,62 l-11,-5 l0,10 z" style="fill:var(--line)"/>
    <rect x="312" y="42" width="160" height="40" rx="8" style="fill:var(--accent-soft);stroke:var(--accent)"/>
    <text x="392" y="67" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">hash(partition key)</text>
    <line x1="472" y1="62" x2="520" y2="62" style="stroke:var(--accent);stroke-width:2"/><path d="M520,62 l-11,-5 l0,10 z" style="fill:var(--accent)"/>
    <text x="610" y="56" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">user=42 → partition A</text>
    <text x="610" y="76" text-anchor="middle" style="fill:var(--muted)">a query with user=42 hits only A</text>
    <path d="M392,84 C392,108 218,108 218,130" style="fill:none;stroke:var(--accent);stroke-width:1.5;stroke-dasharray:5 4"/>
    <path d="M218,132 l-5,-11 l10,1 z" style="fill:var(--accent)"/>
    <rect x="40" y="104" width="680" height="168" rx="12" style="fill:none;stroke:var(--accent);stroke-width:1.5"/>
    <text x="56" y="125" style="fill:var(--accent-ink);font-weight:700">collection</text>
    <rect x="58" y="132" width="320" height="130" rx="10" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="74" y="152" style="fill:var(--accent-ink);font-weight:700">partition A · user=42</text>
    <rect x="74" y="160" width="140" height="92" rx="8" style="fill:var(--panel);stroke:var(--line)"/><text x="144" y="178" text-anchor="middle" style="fill:var(--ink)">segment</text>
    <circle cx="100" cy="206" r="4" style="fill:var(--muted)"/><circle cx="124" cy="206" r="4" style="fill:var(--muted)"/><circle cx="148" cy="206" r="4" style="fill:var(--muted)"/><circle cx="172" cy="206" r="4" style="fill:var(--muted)"/>
    <text x="144" y="240" text-anchor="middle" style="fill:var(--faint)">⊃ entities (rows)</text>
    <rect x="222" y="160" width="140" height="92" rx="8" style="fill:var(--panel);stroke:var(--line)"/><text x="292" y="178" text-anchor="middle" style="fill:var(--ink)">segment</text>
    <circle cx="248" cy="206" r="4" style="fill:var(--muted)"/><circle cx="272" cy="206" r="4" style="fill:var(--muted)"/><circle cx="296" cy="206" r="4" style="fill:var(--muted)"/>
    <rect x="398" y="132" width="304" height="130" rx="10" style="fill:var(--panel-2);stroke:var(--line)"/>
    <text x="414" y="152" style="fill:var(--muted)">partition B · user=99</text>
  ...
  <div class="figcap"><b>Slicing down: collection ⊃ partition ⊃ segment ⊃ entity</b>: <span class="mono">hash(partition key)</span> <b>auto-routes</b> each row into a partition; a query carrying the partition key <b>searches only that partition</b>, pruning a huge swath of data up front.</div>
</div>
...
<div class="vflow">
  ...
  <div class="step"><div class="num">3</div><div class="sc"><h4>异步建索引</h4><p>一个 <strong>DataNode 工作进程</strong>读取 binlog，在其上<strong>构建 ANN 索引</strong>（IVF/HNSW…），索引文件也存进对象存储。（注意：现版本没有独立的 indexnode，建索引由 DataNode 承担——详见第 12 课。）</p></div></div>
...
正是 Milvus 把吞吐做高、把延迟做低的关键。每一环都能独立扩展——写入与建索引都由 DataNode 承担（建索引就跑在 DataNode 工作进程里），所以这两头吃紧就加 DataNode，查得多了就加 QueryNode。</p>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="列式布局：把按行的实体重组成按字段连续存储，每个字段一份 binlog">
    ...
    <rect x="440" y="124" width="34" height="28" rx="5" style="fill:var(--accent-soft);stroke:var(--accent)"/><text x="457" y="143" text-anchor="middle" style="fill:var(--accent-ink)">v</text>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="一条数据的一生：从 WAL 日志，到内存增长段、封存段，到对象存储、建索引；进了日志就已落地、全程可查">
    <rect x="18" y="80" width="132" height="92" rx="10" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1.5"/>
    <text x="84" y="106" text-anchor="middle" style="fill:var(--amber);font-weight:700">① WAL 日志</text>
    <text x="84" y="130" text-anchor="middle" style="fill:var(--muted)">pchannel</text>
    <text x="84" y="156" text-anchor="middle" style="fill:var(--ink)">唯一真相</text>
    <rect x="160" y="80" width="132" height="92" rx="10" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="226" y="106" text-anchor="middle" style="fill:var(--blue);font-weight:700">② Growing</text>
    <text x="226" y="130" text-anchor="middle" style="fill:var(--muted)">内存</text>
    <text x="226" y="156" text-anchor="middle" style="fill:var(--teal);font-weight:700">✓ 立即可查</text>
    <rect x="302" y="80" width="132" height="92" rx="10" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="368" y="106" text-anchor="middle" style="fill:var(--purple);font-weight:700">③ Sealed</text>
    <text x="368" y="130" text-anchor="middle" style="fill:var(--muted)">内存→刷盘</text>
    <text x="368" y="156" text-anchor="middle" style="fill:var(--teal);font-weight:700">✓ 只读</text>
    <rect x="444" y="80" width="132" height="92" rx="10" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="510" y="106" text-anchor="middle" style="fill:var(--teal);font-weight:700">④ Flushed</text>
    <text x="510" y="130" text-anchor="middle" style="fill:var(--muted)">对象存储</text>
    <text x="510" y="156" text-anchor="middle" style="fill:var(--teal);font-weight:700">✓ 不怕崩溃</text>
    <rect x="586" y="80" width="132" height="92" rx="10" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="652" y="106" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">⑤ Indexed</text>
    <text x="652" y="130" text-anchor="middle" style="fill:var(--muted)">+ 索引文件</text>
    <text x="652" y="156" text-anchor="middle" style="fill:var(--teal);font-weight:700">✓ 高效</text>
    <path d="M150,126 l12,0 M160,126 l-9,-4 l0,8 z" style="stroke:var(--line);fill:var(--line);stroke-width:2"/>
    <path d="M292,126 l12,0 M302,126 l-9,-4 l0,8 z" style="stroke:var(--line);fill:var(--line);stroke-width:2"/>
    <path d="M434,126 l12,0 M444,126 l-9,-4 l0,8 z" style="stroke:var(--line);fill:var(--line);stroke-width:2"/>
...
<div class="vflow">
  ...
  <div class="step"><div class="num">3</div><div class="sc"><h4>Build index async</h4><p>A <strong>DataNode worker</strong> reads binlogs and <strong>builds the ANN index</strong> (IVF/HNSW…); index files also go to object storage. (Note: current Milvus has no standalone indexnode — DataNodes do the indexing; see Lesson 12.)</p></div></div>
...
<strong>writing, flushing, indexing, and loading</strong> are independent and non-blocking is exactly how Milvus achieves high throughput and low latency. Each stage scales independently—writing and indexing are both handled by DataNodes (indexing runs inside a DataNode worker), so add DataNodes when either is the bottleneck, and QueryNodes to serve more queries.</p>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="Columnar layout: regroup row-oriented entities into per-field contiguous storage, one binlog per field">
    <text x="40" y="52" style="fill:var(--muted)">logical: 3 rows</text>
    <rect x="40" y="64" width="252" height="36" rx="7" style="fill:var(--panel-2);stroke:var(--line)"/>
    <rect x="48" y="70" width="40" height="24" rx="5" style="fill:var(--blue-soft);stroke:var(--blue)"/><text x="68" y="87" text-anchor="middle" class="mono" style="fill:var(--blue)">1</text>
    <rect x="94" y="70" width="112" height="24" rx="5" style="fill:var(--accent-soft);stroke:var(--accent)"/><text x="150" y="87" text-anchor="middle" style="fill:var(--accent-ink)">vec</text>
    <rect x="212" y="70" width="72" height="24" rx="5" style="fill:var(--amber-soft);stroke:var(--amber)"/><text x="248" y="87" text-anchor="middle" class="mono" style="fill:var(--amber)">9.9</text>
    ...
    <rect x="212" y="154" width="72" height="24" rx="5" style="fill:var(--amber-soft);stroke:var(--amber)"/><text x="248" y="171" text-anchor="middle" class="mono" style="fill:var(--amber)">7.0</text>
    <line x1="300" y1="124" x2="340" y2="124" style="stroke:var(--line);stroke-width:2"/><path d="M340,124 l-11,-5 l0,10 z" style="fill:var(--line)"/>
    <text x="320" y="114" text-anchor="middle" style="fill:var(--muted)">by field</text>
    <text x="352" y="52" style="fill:var(--muted)">physical: each field contiguous · one binlog each</text>
    <text x="354" y="86" style="fill:var(--blue);font-weight:700">id</text>
    <rect x="404" y="68" width="34" height="28" rx="5" style="fill:var(--blue-soft);stroke:var(--blue)"/><text x="421" y="87" text-anchor="middle" class="mono" style="fill:var(--blue)">1</text>
    <rect x="440" y="68" width="34" height="28" rx="5" style="fill:var(--blue-soft);stroke:var(--blue)"/><text x="457" y="87" text-anchor="middle" class="mono" style="fill:var(--blue)">2</text>
    <rect x="476" y="68" width="34" height="28" rx="5" style="fill:var(--blue-soft);stroke:var(--blue)"/><text x="493" y="87" text-anchor="middle" class="mono" style="fill:var(--blue)">3</text>
    <text x="528" y="86" style="fill:var(--muted)">→ 1 binlog</text>
    <text x="354" y="142" style="fill:var(--accent-ink);font-weight:700">vector</text>
    <rect x="404" y="124" width="34" height="28" rx="5" style="fill:var(--accent-soft);stroke:var(--accent)"/><text x="421" y="143" text-anchor="middle" style="fill:var(--accent-ink)">v</text>
    <rect x="440" y="124" width="34" height="28" rx="5" style="fill:var(--accent-soft);stroke:var(--accent)"/><text x="457" y="143" text-anchor="middle" style="fill:var(--accent-ink)">v</text>
    <rect x="476" y="124" width="34" height="28" rx="5" style="fill:var(--accent-soft);stroke:var(--accent)"/><text x="493" y="143" text-anchor="middle" style="fill:var(--accent-ink)">v</text>
    <text x="528" y="142" style="fill:var(--muted)">→ 1 binlog</text>
    <text x="354" y="198" style="fill:var(--amber);font-weight:700">price</text>
    <rect x="404" y="180" width="44" height="28" rx="5" style="fill:var(--amber-soft);stroke:var(--amber)"/><text x="426" y="199" text-anchor="middle" class="mono" style="fill:var(--amber)">9.9</text>
    <rect x="450" y="180" width="44" height="28" rx="5" style="fill:var(--amber-soft);stroke:var(--amber)"/><text x="472" y="199" text-anchor="middle" class="mono" style="fill:var(--amber)">3.5</text>
    <rect x="496" y="180" width="44" height="28" rx="5" style="fill:var(--amber-soft);stroke:var(--amber)"/><text x="518" y="199" text-anchor="middle" class="mono" style="fill:var(--amber)">7.0</text>
    <text x="556" y="198" style="fill:var(--muted)">→ 1 binlog</text>
  </svg>
  <div class="figcap"><b>Columnar, not row-wise</b>: all values of one field sit <b>contiguously together</b>, each field flushed as <b>one binlog</b>. Vector search "pulls a whole column out and computes distances in bulk" — hence very fast (cache-friendly, vectorizable); scalar filtering scans only the relevant columns.</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="The life of one row: from the WAL log, to the in-memory growing and sealed segments, to object storage and an index; once in the log it has landed and stays searchable">
    <rect x="18" y="80" width="132" height="92" rx="10" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1.5"/>
    <text x="84" y="106" text-anchor="middle" style="fill:var(--amber);font-weight:700">① WAL log</text>
    <text x="84" y="130" text-anchor="middle" style="fill:var(--muted)">pchannel</text>
    <text x="84" y="156" text-anchor="middle" style="fill:var(--ink)">only truth</text>
    <rect x="160" y="80" width="132" height="92" rx="10" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="226" y="106" text-anchor="middle" style="fill:var(--blue);font-weight:700">② Growing</text>
    <text x="226" y="130" text-anchor="middle" style="fill:var(--muted)">memory</text>
    <text x="226" y="156" text-anchor="middle" style="fill:var(--teal);font-weight:700">✓ instantly</text>
    <rect x="302" y="80" width="132" height="92" rx="10" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="368" y="106" text-anchor="middle" style="fill:var(--purple);font-weight:700">③ Sealed</text>
    <text x="368" y="130" text-anchor="middle" style="fill:var(--muted)">mem→flush</text>
    <text x="368" y="156" text-anchor="middle" style="fill:var(--teal);font-weight:700">✓ read-only</text>
    <rect x="444" y="80" width="132" height="92" rx="10" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="510" y="106" text-anchor="middle" style="fill:var(--teal);font-weight:700">④ Flushed</text>
    <text x="510" y="130" text-anchor="middle" style="fill:var(--muted)">object store</text>
    <text x="510" y="156" text-anchor="middle" style="fill:var(--teal);font-weight:700">✓ crash-proof</text>
    <rect x="586" y="80" width="132" height="92" rx="10" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="652" y="106" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">⑤ Indexed</text>
    <text x="652" y="130" text-anchor="middle" style="fill:var(--muted)">+ index files</text>
    <text x="652" y="156" text-anchor="middle" style="fill:var(--teal);font-weight:700">✓ efficient</text>
    <path d="M150,126 l12,0 M160,126 l-9,-4 l0,8 z" style="stroke:var(--line);fill:var(--line);stroke-width:2"/>
    <path d="M292,126 l12,0 M302,126 l-9,-4 l0,8 z" style="stroke:var(--line);fill:var(--line);stroke-width:2"/>
    <path d="M434,126 l12,0 M444,126 l-9,-4 l0,8 z" style="stroke:var(--line);fill:var(--line);stroke-width:2"/>
    <path d="M576,126 l12,0 M586,126 l-9,-4 l0,8 z" style="stroke:var(--line);fill:var(--line);stroke-width:2"/>
...
<div class="cols">
  <div class="col"><h4>❌ 什么都自己造</h4><p>要重复造一致性存储、海量对象存储、有序日志这些<strong>成熟的轮子</strong>，还得各自操心可靠性、扩展性、容灾——又重又难，且未必比专门系统做得好。</p></div>
  <div class="col"><h4>✅ 复用成熟组件</h4><p>元数据→<strong>etcd</strong>(强一致/可监听)、数据→<strong>对象存储</strong>(便宜/近无限)、日志→<strong>消息队列</strong>(有序/可重放)。把"难且通用"的事外包，自己专注<strong>向量检索</strong>。</p></div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="三大外部依赖：etcd 是账本（元数据），对象存储是仓库（binlog 与索引），消息队列是日志（WAL），对应三种不同的存储需求">
    <rect x="20" y="56" width="232" height="206" rx="12" style="fill:var(--panel-2);stroke:var(--blue);stroke-width:1.5"/>
    <text x="136" y="86" text-anchor="middle" style="fill:var(--blue);font-weight:700">① etcd · 账本</text>
    <line x1="40" y1="98" x2="232" y2="98" style="stroke:var(--blue);stroke-width:1.5;opacity:.45"/>
    ...
    <text x="136" y="176" text-anchor="middle" style="fill:var(--ink)">元数据 + 服务发现</text>
    <rect x="40" y="188" width="192" height="30" rx="8" style="fill:var(--blue-soft);stroke:var(--blue)"/><text x="136" y="208" text-anchor="middle" style="fill:var(--blue);font-weight:700">小而关键 · 强一致</text>
    <text x="136" y="242" text-anchor="middle" class="mono" style="fill:var(--muted)">etcd（K8s 同款）</text>
    <rect x="264" y="56" width="232" height="206" rx="12" style="fill:var(--panel-2);stroke:var(--teal);stroke-width:1.5"/>
    <text x="380" y="86" text-anchor="middle" style="fill:var(--teal);font-weight:700">② 对象存储 · 仓库</text>
    ...
    <text x="380" y="176" text-anchor="middle" style="fill:var(--ink)">binlog + 索引文件</text>
    <rect x="284" y="188" width="192" height="30" rx="8" style="fill:var(--teal-soft);stroke:var(--teal)"/><text x="380" y="208" text-anchor="middle" style="fill:var(--teal);font-weight:700">大而廉价 · 近乎无限</text>
    ...
    <text x="624" y="86" text-anchor="middle" style="fill:var(--amber);font-weight:700">③ 消息队列 · 日志</text>
    <line x1="528" y1="98" x2="720" y2="98" style="stroke:var(--amber);stroke-width:1.5;opacity:.45"/>
    <rect x="588" y="120" width="16" height="24" rx="2" style="fill:none;stroke:var(--amber);stroke-width:2"/><rect x="606" y="120" width="16" height="24" rx="2" style="fill:none;stroke:var(--amber);stroke-width:2"/><rect x="624" y="120" width="16" height="24" rx="2" style="fill:none;stroke:var(--amber);stroke-width:2"/><rect x="642" y="120" width="16" height="24" rx="2" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:2"/>
    <text x="624" y="176" text-anchor="middle" style="fill:var(--ink)">有序写入日志（WAL）</text>
    <rect x="528" y="188" width="192" height="30" rx="8" style="fill:var(--amber-soft);stroke:var(--amber)"/><text x="624" y="208" text-anchor="middle" style="fill:var(--amber);font-weight:700">有序可重放 · 日志即数据</text>
    <text x="624" y="242" text-anchor="middle" class="mono" style="fill:var(--muted)">Pulsar / Kafka / Woodpecker</text>
  </svg>
  <div class="figcap"><b>三类依赖，三种存储需求</b>：把<b>账本</b>（小而关键的元数据，要强一致）、<b>仓库</b>（海量廉价的 binlog 与索引）、<b>日志</b>（有序可重放的写入流）各自外包给最擅长的成熟系统——Milvus 自身因此能<b>无状态、可随意伸缩</b>。</div>
</div>
...
<div class="cols">
  <div class="col"><h4>❌ Build everything yourself</h4><p>reinvent consistency storage, massive object storage, ordered logs — <strong>mature wheels</strong> — and worry about each one's reliability, scalability, DR separately. Heavy, hard, and unlikely to beat the specialists.</p></div>
  <div class="col"><h4>✅ Reuse mature components</h4><p>metadata→<strong>etcd</strong> (strong consistency/watchable), data→<strong>object storage</strong> (cheap/near-infinite), log→<strong>message queue</strong> (ordered/replayable). Outsource the "hard and generic", focus on <strong>vector search</strong>.</p></div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="Three external dependencies: etcd is the ledger (metadata), object storage is the warehouse (binlogs and indexes), the message queue is the log (WAL) — three distinct storage needs">
    <rect x="20" y="56" width="232" height="206" rx="12" style="fill:var(--panel-2);stroke:var(--blue);stroke-width:1.5"/>
    <text x="136" y="86" text-anchor="middle" style="fill:var(--blue);font-weight:700">① etcd · ledger</text>
    <line x1="40" y1="98" x2="232" y2="98" style="stroke:var(--blue);stroke-width:1.5;opacity:.45"/>
    <rect x="114" y="116" width="44" height="34" rx="4" style="fill:none;stroke:var(--blue);stroke-width:2"/>
    <line x1="122" y1="127" x2="150" y2="127" style="stroke:var(--blue);stroke-width:2"/><line x1="122" y1="135" x2="150" y2="135" style="stroke:var(--blue);stroke-width:2"/><line x1="122" y1="143" x2="142" y2="143" style="stroke:var(--blue);stroke-width:2"/>
    ...
    <line x1="528" y1="98" x2="720" y2="98" style="stroke:var(--amber);stroke-width:1.5;opacity:.45"/>
    <rect x="588" y="120" width="16" height="24" rx="2" style="fill:none;stroke:var(--amber);stroke-width:2"/><rect x="606" y="120" width="16" height="24" rx="2" style="fill:none;stroke:var(--amber);stroke-width:2"/><rect x="624" y="120" width="16" height="24" rx="2" style="fill:none;stroke:var(--amber);stroke-width:2"/><rect x="642" y="120" width="16" height="24" rx="2" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:2"/>
    <text x="624" y="176" text-anchor="middle" style="fill:var(--ink)">ordered write log (WAL)</text>
    <rect x="528" y="188" width="192" height="30" rx="8" style="fill:var(--amber-soft);stroke:var(--amber)"/><text x="624" y="208" text-anchor="middle" style="fill:var(--amber);font-weight:700">ordered &amp; replayable</text>
    <text x="624" y="242" text-anchor="middle" class="mono" style="fill:var(--muted)">Pulsar / Kafka / Woodpecker</text>
  </svg>
  <div class="figcap"><b>Three dependencies, three storage needs</b>: outsource the <b>ledger</b> (small, critical metadata needing strong consistency), the <b>warehouse</b> (vast, cheap binlogs and indexes), and the <b>log</b> (an ordered, replayable write stream) each to the system best at it — which is why Milvus itself can stay <b>stateless and freely scalable</b>.</div>
</div>

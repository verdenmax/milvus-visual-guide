...
<div class="cellgroup">
  ...
  <div class="cells"><span class="lab">v2</span><span class="cell">0.20</span><span class="cell">0.95</span><span class="cell">0.15</span><span class="sep">→</span><span class="cell dim">距离 1.28</span></div>
  <div class="cells"><span class="lab">v3</span><span class="cell">0.85</span><span class="cell">0.05</span><span class="cell">0.83</span><span class="sep">→</span><span class="cell q">距离 0.08 ✓</span></div>
  <div class="cells"><span class="lab">v4</span><span class="cell">0.10</span><span class="cell">0.30</span><span class="cell">0.90</span><span class="sep">→</span><span class="cell dim">距离 0.83</span></div>
</div>

<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="向量空间中按距离寻找最近邻：查询点与四个候选，最近的两个入选 topK">
    <text x="40" y="32" style="fill:var(--muted)">向量空间（示意 · 2D 投影）</text>
    <circle cx="250" cy="166" r="112" style="fill:var(--accent-soft);opacity:.30"/>
    <circle cx="250" cy="166" r="112" style="fill:none;stroke:var(--accent);stroke-width:1.5;stroke-dasharray:5 5"/>
    <text x="250" y="296" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">topK=2 · 取半径内最近的两个</text>
    <line x1="250" y1="166" x2="322" y2="140" style="stroke:var(--accent);stroke-width:2"/>
    <line x1="250" y1="166" x2="300" y2="230" style="stroke:var(--accent);stroke-width:2"/>
    <line x1="250" y1="166" x2="600" y2="250" style="stroke:var(--line);stroke-width:1.5;stroke-dasharray:4 4"/>
    <line x1="250" y1="166" x2="618" y2="92" style="stroke:var(--line);stroke-width:1.5;stroke-dasharray:4 4"/>
    <circle cx="322" cy="140" r="11" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:2"/>
    <text x="322" y="120" text-anchor="middle" style="fill:var(--ink);font-weight:600">v1</text>
    <text x="348" y="150" class="mono" style="fill:var(--accent-ink)">0.03 ✓</text>
    <circle cx="300" cy="230" r="11" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:2"/>
    <text x="300" y="254" text-anchor="middle" style="fill:var(--ink);font-weight:600">v3</text>
    <text x="322" y="230" class="mono" style="fill:var(--accent-ink)">0.08 ✓</text>
    <circle cx="600" cy="250" r="11" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="600" y="234" text-anchor="middle" style="fill:var(--muted)">v4</text>
    <text x="548" y="266" class="mono" style="fill:var(--muted)">0.83</text>
    <circle cx="618" cy="92" r="11" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="618" y="76" text-anchor="middle" style="fill:var(--muted)">v2</text>
    <text x="566" y="92" class="mono" style="fill:var(--muted)">1.28</text>
    <circle cx="250" cy="166" r="9" style="fill:var(--accent)"/>
    <circle cx="250" cy="166" r="15" style="fill:none;stroke:var(--accent);stroke-width:1.5"/>
    <text x="222" y="171" text-anchor="end" style="fill:var(--accent-ink);font-weight:700">q</text>
  </svg>
  <div class="figcap"><b>搜索 = 找最近邻</b>：把查询 <span class="mono">q</span> 与库内向量都看作空间里的点，按<b>距离</b>排序取最近的 K 个。<span class="mono">v1·0.03</span>、<span class="mono">v3·0.08</span> 落入 topK 半径，入选；<span class="mono">v4·0.83</span>、<span class="mono">v2·1.28</span> 太远，被甩开。</div>
</div>
...
<div class="cellgroup">
  ...
  <div class="cells"><span class="lab">v2</span><span class="cell">0.20</span><span class="cell">0.95</span><span class="cell">0.15</span><span class="sep">→</span><span class="cell dim">dist 1.28</span></div>
  <div class="cells"><span class="lab">v3</span><span class="cell">0.85</span><span class="cell">0.05</span><span class="cell">0.83</span><span class="sep">→</span><span class="cell q">dist 0.08 ✓</span></div>
  <div class="cells"><span class="lab">v4</span><span class="cell">0.10</span><span class="cell">0.30</span><span class="cell">0.90</span><span class="sep">→</span><span class="cell dim">dist 0.83</span></div>
</div>

<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="Finding nearest neighbors by distance: a query point and four candidates; the two closest are selected">
    <text x="40" y="32" style="fill:var(--muted)">vector space (sketch · 2D projection)</text>
    <circle cx="250" cy="166" r="112" style="fill:var(--accent-soft);opacity:.30"/>
    <circle cx="250" cy="166" r="112" style="fill:none;stroke:var(--accent);stroke-width:1.5;stroke-dasharray:5 5"/>
    <text x="250" y="296" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">topK=2 · keep the two nearest inside the radius</text>
    <line x1="250" y1="166" x2="322" y2="140" style="stroke:var(--accent);stroke-width:2"/>
    <line x1="250" y1="166" x2="300" y2="230" style="stroke:var(--accent);stroke-width:2"/>
    <line x1="250" y1="166" x2="600" y2="250" style="stroke:var(--line);stroke-width:1.5;stroke-dasharray:4 4"/>
    <line x1="250" y1="166" x2="618" y2="92" style="stroke:var(--line);stroke-width:1.5;stroke-dasharray:4 4"/>
  ...
  <div class="figcap"><b>Search = nearest neighbors</b>: treat the query <span class="mono">q</span> and stored vectors as points; sort by <b>distance</b> and keep the K closest. <span class="mono">v1·0.03</span> and <span class="mono">v3·0.08</span> fall inside the topK radius and are selected; <span class="mono">v4·0.83</span> and <span class="mono">v2·1.28</span> are too far and dropped.</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="崩溃与重放：内存增长段宕机即丢，但可从 WAL 检查点之后重放、原样重建">
    <rect x="250" y="46" width="300" height="86" rx="12" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="400" y="72" text-anchor="middle" style="fill:var(--ink);font-weight:700">增长段 · 内存中的中间结果</text>
    <rect x="298" y="86" width="92" height="32" rx="6" style="fill:var(--panel);stroke:var(--line)"/><text x="344" y="107" text-anchor="middle" class="mono" style="fill:var(--muted)">row 104</text>
    <rect x="410" y="86" width="92" height="32" rx="6" style="fill:var(--panel);stroke:var(--line)"/><text x="456" y="107" text-anchor="middle" class="mono" style="fill:var(--muted)">row 105</text>
    <path d="M150,52 l34,0 l-20,30 l28,0 l-50,66 l14,-44 l-26,0 z" style="fill:var(--red);opacity:.9"/>
    <text x="150" y="170" text-anchor="middle" style="fill:var(--red);font-weight:700">① 宕机：内存清空</text>
    <line x1="186" y1="90" x2="248" y2="90" style="stroke:var(--red);stroke-width:2;stroke-dasharray:3 3"/>
    <path d="M248,90 l-11,-5 l0,10 z" style="fill:var(--red)"/>
    <path d="M410,232 C410,190 520,196 520,134" style="fill:none;stroke:var(--teal);stroke-width:2.5"/>
    <path d="M520,134 l-5,11 l10,-1 z" style="fill:var(--teal)"/>
    <text x="548" y="150" style="fill:var(--teal);font-weight:700">② 检查点后重放</text>
    <text x="548" y="172" style="fill:var(--teal)">→ 原样重建</text>
    <text x="70" y="224" style="fill:var(--muted)">WAL · 只追加、天然有序、可重放（消息队列 / 对象存储 · 唯一真相）</text>
    <rect x="70" y="234" width="92" height="42" rx="6" style="fill:var(--panel-2);stroke:var(--line)"/><text x="116" y="261" text-anchor="middle" class="mono" style="fill:var(--muted)">100</text>
    <rect x="168" y="234" width="92" height="42" rx="6" style="fill:var(--panel-2);stroke:var(--line)"/><text x="214" y="261" text-anchor="middle" class="mono" style="fill:var(--muted)">101</text>
    <rect x="266" y="234" width="92" height="42" rx="6" style="fill:var(--panel-2);stroke:var(--line)"/><text x="312" y="261" text-anchor="middle" class="mono" style="fill:var(--muted)">102</text>
    <rect x="364" y="234" width="92" height="42" rx="6" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/><text x="410" y="261" text-anchor="middle" class="mono" style="fill:var(--accent-ink)">103</text>
    <rect x="462" y="234" width="92" height="42" rx="6" style="fill:var(--panel);stroke:var(--teal);stroke-width:1.5"/><text x="508" y="261" text-anchor="middle" class="mono" style="fill:var(--ink)">104</text>
    <rect x="560" y="234" width="92" height="42" rx="6" style="fill:var(--panel);stroke:var(--teal);stroke-width:1.5"/><text x="606" y="261" text-anchor="middle" class="mono" style="fill:var(--ink)">105</text>
    <text x="410" y="294" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">↑ checkpoint（书签）</text>
    <line x1="654" y1="255" x2="692" y2="255" style="stroke:var(--line);stroke-width:2"/>
    <path d="M692,255 l-11,-5 l0,10 z" style="fill:var(--line)"/>
    <text x="700" y="240" style="fill:var(--muted)">追加</text>
  </svg>
  <div class="figcap"><b>崩溃即重放</b>：内存里的增长段宕机就没了，但<b>唯一真相 WAL</b> 完好。重启后不必从头读，只<b>从检查点 103 之后</b>重放 <span class="mono">104、105</span>，增长段被<b>原样重建</b>——这正是"日志即数据"最实在的红利。</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="Crash and replay: the in-memory growing segment is lost on crash but rebuilt by replaying the WAL after the checkpoint">
    <rect x="250" y="46" width="300" height="86" rx="12" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="400" y="72" text-anchor="middle" style="fill:var(--ink);font-weight:700">growing segment · in-memory intermediate</text>
    <rect x="298" y="86" width="92" height="32" rx="6" style="fill:var(--panel);stroke:var(--line)"/><text x="344" y="107" text-anchor="middle" class="mono" style="fill:var(--muted)">row 104</text>
    <rect x="410" y="86" width="92" height="32" rx="6" style="fill:var(--panel);stroke:var(--line)"/><text x="456" y="107" text-anchor="middle" class="mono" style="fill:var(--muted)">row 105</text>
    <path d="M150,52 l34,0 l-20,30 l28,0 l-50,66 l14,-44 l-26,0 z" style="fill:var(--red);opacity:.9"/>
    <text x="150" y="170" text-anchor="middle" style="fill:var(--red);font-weight:700">① crash: memory wiped</text>
    <line x1="186" y1="90" x2="248" y2="90" style="stroke:var(--red);stroke-width:2;stroke-dasharray:3 3"/>
    <path d="M248,90 l-11,-5 l0,10 z" style="fill:var(--red)"/>
    <path d="M410,232 C410,190 520,196 520,134" style="fill:none;stroke:var(--teal);stroke-width:2.5"/>
    <path d="M520,134 l-5,11 l10,-1 z" style="fill:var(--teal)"/>
    <text x="548" y="146" style="fill:var(--teal);font-weight:700">② replay after</text>
    <text x="548" y="166" style="fill:var(--teal);font-weight:700">the checkpoint</text>
    <text x="548" y="186" style="fill:var(--teal)">→ rebuilt as-is</text>
    <text x="70" y="224" style="fill:var(--muted)">WAL · append-only, ordered, replayable (MQ / object storage · single source of truth)</text>
    <rect x="70" y="234" width="92" height="42" rx="6" style="fill:var(--panel-2);stroke:var(--line)"/><text x="116" y="261" text-anchor="middle" class="mono" style="fill:var(--muted)">100</text>
    <rect x="168" y="234" width="92" height="42" rx="6" style="fill:var(--panel-2);stroke:var(--line)"/><text x="214" y="261" text-anchor="middle" class="mono" style="fill:var(--muted)">101</text>
    <rect x="266" y="234" width="92" height="42" rx="6" style="fill:var(--panel-2);stroke:var(--line)"/><text x="312" y="261" text-anchor="middle" class="mono" style="fill:var(--muted)">102</text>
    <rect x="364" y="234" width="92" height="42" rx="6" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/><text x="410" y="261" text-anchor="middle" class="mono" style="fill:var(--accent-ink)">103</text>
    <rect x="462" y="234" width="92" height="42" rx="6" style="fill:var(--panel);stroke:var(--teal);stroke-width:1.5"/><text x="508" y="261" text-anchor="middle" class="mono" style="fill:var(--ink)">104</text>
    <rect x="560" y="234" width="92" height="42" rx="6" style="fill:var(--panel);stroke:var(--teal);stroke-width:1.5"/><text x="606" y="261" text-anchor="middle" class="mono" style="fill:var(--ink)">105</text>
    <text x="410" y="294" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">↑ checkpoint (bookmark)</text>
    <line x1="654" y1="255" x2="692" y2="255" style="stroke:var(--line);stroke-width:2"/>
    <path d="M692,255 l-11,-5 l0,10 z" style="fill:var(--line)"/>
    <text x="700" y="240" style="fill:var(--muted)">append</text>
  </svg>
  <div class="figcap"><b>Crash = replay</b>: the in-memory growing segment vanishes on crash, but the <b>single source of truth, the WAL</b>, is intact. On restart it need not reread from the start — it replays only <span class="mono">104, 105</span> <b>after checkpoint 103</b>, rebuilding the segment <b>exactly</b> — the most concrete payoff of "log as data".</div>
</div>

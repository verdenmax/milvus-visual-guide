...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="控制面决定谁做什么、数据面真正执行；用户数据吞吐只在数据面流动，不穿过控制面">
    <rect x="20" y="36" width="720" height="86" rx="12" style="fill:var(--accent-soft);opacity:.22"/>
    <text x="36" y="58" style="fill:var(--accent-ink);font-weight:700">控制面 control plane · 决定谁做什么（低频）</text>
    <rect x="300" y="64" width="190" height="48" rx="10" style="fill:var(--panel);stroke:var(--accent);stroke-width:1.5"/><text x="395" y="93" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">MixCoord 协调者</text>
    <rect x="520" y="64" width="150" height="48" rx="10" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/><text x="595" y="93" text-anchor="middle" style="fill:var(--blue);font-weight:700">etcd · 真相</text>
    <line x1="490" y1="88" x2="518" y2="88" style="stroke:var(--line);stroke-width:1.5;stroke-dasharray:3 3"/>
    <rect x="20" y="182" width="720" height="96" rx="12" style="fill:var(--teal-soft);opacity:.20"/>
    <text x="36" y="204" style="fill:var(--teal);font-weight:700">数据面 data plane · 真正干活（高频吞吐）</text>
    <rect x="60" y="214" width="160" height="50" rx="10" style="fill:var(--panel);stroke:var(--teal);stroke-width:1.5"/><text x="140" y="244" text-anchor="middle" style="fill:var(--ink)">Proxy</text>
    <rect x="300" y="214" width="160" height="50" rx="10" style="fill:var(--panel);stroke:var(--teal);stroke-width:1.5"/><text x="380" y="244" text-anchor="middle" style="fill:var(--ink)">QueryNode</text>
    <rect x="540" y="214" width="160" height="50" rx="10" style="fill:var(--panel);stroke:var(--teal);stroke-width:1.5"/><text x="620" y="244" text-anchor="middle" style="fill:var(--ink)">DataNode</text>
    <line x1="220" y1="231" x2="296" y2="231" style="stroke:var(--teal);stroke-width:4"/><path d="M296,231 l-12,-6 l0,12 z" style="fill:var(--teal)"/>
    <line x1="220" y1="251" x2="536" y2="251" style="stroke:var(--teal);stroke-width:4"/><path d="M536,251 l-12,-6 l0,12 z" style="fill:var(--teal)"/>
    <text x="474" y="206" style="fill:var(--teal)">用户数据：search / insert 字节</text>
    ...
    <text x="406" y="152" style="fill:var(--accent-ink);font-weight:700">决策·调度（低频）</text>
    ...
    <text x="168" y="150" style="fill:var(--red);font-weight:700">高频吞吐 ✗ 不上控制面</text>
  </svg>
  <div class="figcap"><b>决策 vs 执行</b>：<b>控制面</b>（协调者 + etcd）只在低频时刻做决定、持有<b>权威元数据</b>；<b>数据面</b>（节点）扛住高频的<b>用户数据吞吐</b>。两条铁律：<b>吞吐绝不穿过控制面</b>，跨面只走<b>接口与 etcd</b>。</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="The control plane decides who does what; the data plane executes; user-data throughput flows only within the data plane and never crosses into the control plane">
    <rect x="20" y="36" width="720" height="86" rx="12" style="fill:var(--accent-soft);opacity:.22"/>
    <text x="36" y="58" style="fill:var(--accent-ink);font-weight:700">control plane · decides who does what (low frequency)</text>
    <rect x="300" y="64" width="190" height="48" rx="10" style="fill:var(--panel);stroke:var(--accent);stroke-width:1.5"/><text x="395" y="93" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">MixCoord</text>
    <rect x="520" y="64" width="150" height="48" rx="10" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/><text x="595" y="93" text-anchor="middle" style="fill:var(--blue);font-weight:700">etcd · truth</text>
    <line x1="490" y1="88" x2="518" y2="88" style="stroke:var(--line);stroke-width:1.5;stroke-dasharray:3 3"/>
    <rect x="20" y="182" width="720" height="96" rx="12" style="fill:var(--teal-soft);opacity:.20"/>
    <text x="36" y="204" style="fill:var(--teal);font-weight:700">data plane · does the work (high-frequency throughput)</text>
    <rect x="60" y="214" width="160" height="50" rx="10" style="fill:var(--panel);stroke:var(--teal);stroke-width:1.5"/><text x="140" y="244" text-anchor="middle" style="fill:var(--ink)">Proxy</text>
    <rect x="300" y="214" width="160" height="50" rx="10" style="fill:var(--panel);stroke:var(--teal);stroke-width:1.5"/><text x="380" y="244" text-anchor="middle" style="fill:var(--ink)">QueryNode</text>
    <rect x="540" y="214" width="160" height="50" rx="10" style="fill:var(--panel);stroke:var(--teal);stroke-width:1.5"/><text x="620" y="244" text-anchor="middle" style="fill:var(--ink)">DataNode</text>
    <line x1="220" y1="231" x2="296" y2="231" style="stroke:var(--teal);stroke-width:4"/><path d="M296,231 l-12,-6 l0,12 z" style="fill:var(--teal)"/>
  ...
  <div class="figcap"><b>Decide vs execute</b>: the <b>control plane</b> (coordinators + etcd) only decides at low-frequency moments and holds the <b>authoritative metadata</b>; the <b>data plane</b> (nodes) absorbs high-frequency <b>user-data throughput</b>. Two hard rules: <b>throughput never crosses into control</b>, and cross-plane talk goes only through <b>interfaces and etcd</b>.</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="一次请求依次经过鉴权、权限、数据库路由、限流四道拦截器，任一不过即被拦下；通过后才进入排队执行">
    ...
    <text x="588" y="172" text-anchor="middle" style="fill:var(--faint)">配额</text>
    <line x1="126" y1="146" x2="144" y2="146" style="stroke:var(--line);stroke-width:2"/><path d="M144,146 l-10,-5 l0,10 z" style="fill:var(--line)"/>
    <line x1="238" y1="146" x2="276" y2="146" style="stroke:var(--line);stroke-width:2"/><path d="M276,146 l-10,-5 l0,10 z" style="fill:var(--line)"/>
    <line x1="370" y1="146" x2="408" y2="146" style="stroke:var(--line);stroke-width:2"/><path d="M408,146 l-10,-5 l0,10 z" style="fill:var(--line)"/>
    <line x1="502" y1="146" x2="540" y2="146" style="stroke:var(--line);stroke-width:2"/><path d="M540,146 l-10,-5 l0,10 z" style="fill:var(--line)"/>
    <line x1="634" y1="146" x2="668" y2="146" style="stroke:var(--teal);stroke-width:2.5"/><path d="M668,146 l-11,-5 l0,10 z" style="fill:var(--teal)"/>
    <text x="700" y="138" text-anchor="middle" style="fill:var(--teal);font-weight:700">✓ 通过</text>
    <text x="700" y="158" text-anchor="middle" style="fill:var(--muted)">排队执行</text>
    <path d="M588,202 l0,28" style="stroke:var(--red);stroke-width:2.5"/><path d="M588,230 l-5,-11 l10,0 z" style="fill:var(--red)"/>
...
<div class="cols">
  <div class="col"><h4>ddQueue（DDL）</h4><p>数据定义：建/删集合、建索引等。<strong>串行</strong>执行，保证结构变更有序、不打架。</p></div>
  <div class="col"><h4>dmQueue（DML）</h4><p>数据写入：insert/delete/upsert。要保证同一分片内的<strong>定序</strong>，可并发但守顺序。</p></div>
  <div class="col"><h4>dqQueue（DQL）</h4><p>数据查询：search/query。<strong>读多、可高并发</strong>，与写互不阻塞，各跑各的。</p></div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="Proxy 把写和读分成两条路：写沿 WAL 顺序持久化，读扇出到各分片再归并成全局 topK">
    <rect x="24" y="116" width="116" height="64" rx="11" style="fill:var(--panel);stroke:var(--accent);stroke-width:1.5"/>
    <text x="82" y="144" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">Proxy</text>
    <text x="82" y="164" text-anchor="middle" style="fill:var(--muted)">分派</text>
    <path d="M140,130 C170,130 172,80 200,80" style="fill:none;stroke:var(--amber);stroke-width:2.5"/><path d="M200,80 l-12,-5 l2,11 z" style="fill:var(--amber)"/>
    <rect x="202" y="58" width="160" height="44" rx="9" style="fill:var(--amber-soft);stroke:var(--amber)"/><text x="282" y="85" text-anchor="middle" style="fill:var(--amber);font-weight:700">WAL / MQ · 按 vchannel</text>
    <line x1="362" y1="80" x2="398" y2="80" style="stroke:var(--line);stroke-width:2"/><path d="M398,80 l-11,-5 l0,10 z" style="fill:var(--line)"/>
    <rect x="400" y="58" width="180" height="44" rx="9" style="fill:var(--panel);stroke:var(--teal);stroke-width:1.5"/><text x="490" y="85" text-anchor="middle" style="fill:var(--ink)">StreamingNode/DataNode 落盘</text>
    <text x="600" y="76" style="fill:var(--amber);font-weight:700">写</text><text x="600" y="94" style="fill:var(--muted)">顺序+持久</text>
    <path d="M140,166 C170,166 173,216 196,216" style="fill:none;stroke:var(--blue);stroke-width:2.5"/>
    <path d="M196,196 l-2,0 M196,234 l-2,0" style="stroke:none"/>
    <line x1="178" y1="216" x2="200" y2="196" style="stroke:var(--blue);stroke-width:1.5"/><path d="M200,196 l-11,2 l5,7 z" style="fill:var(--blue)"/>
    <line x1="178" y1="216" x2="200" y2="252" style="stroke:var(--blue);stroke-width:1.5"/><path d="M200,252 l-6,-9 l-3,10 z" style="fill:var(--blue)"/>
    <rect x="200" y="182" width="150" height="28" rx="7" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/><text x="275" y="201" text-anchor="middle" style="fill:var(--ink)">QueryNode 分片①</text>
    <rect x="200" y="216" width="150" height="28" rx="7" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/><text x="275" y="235" text-anchor="middle" style="fill:var(--ink)">QueryNode 分片②</text>
    <rect x="200" y="250" width="150" height="28" rx="7" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/><text x="275" y="269" text-anchor="middle" style="fill:var(--ink)">QueryNode 分片③</text>
    <line x1="350" y1="196" x2="430" y2="222" style="stroke:var(--blue);stroke-width:1.5"/>
    <line x1="350" y1="230" x2="430" y2="228" style="stroke:var(--blue);stroke-width:1.5"/>
    <line x1="350" y1="264" x2="430" y2="234" style="stroke:var(--blue);stroke-width:1.5"/>
    <rect x="432" y="200" width="150" height="56" rx="10" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/><text x="507" y="224" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">归并 reduce</text><text x="507" y="244" text-anchor="middle" style="fill:var(--muted)">局部 topK → 全局</text>
    ...
    <text x="650" y="222" style="fill:var(--blue);font-weight:700">读</text><text x="650" y="240" style="fill:var(--muted)">并发+延迟</text>
  </svg>
  <div class="figcap"><b>一个 Proxy，两条路</b>：<b>写</b>沿 <span class="mono">WAL</span> <b>顺序、持久</b>地落下（写成功即返回，后台落盘）；<b>读</b>则<b>扇出</b>到各分片 QueryNode 各算局部 topK，再<b>归并</b>成全局 topK——<b>最慢的分片决定整体延迟</b>。</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="A request passes four interceptors in order — auth, privilege, db routing, rate-limit; failing any one stops it; only after passing does it reach queue and execution">
    ...
    <text x="588" y="172" text-anchor="middle" style="fill:var(--faint)">quota</text>
    <line x1="126" y1="146" x2="144" y2="146" style="stroke:var(--line);stroke-width:2"/><path d="M144,146 l-10,-5 l0,10 z" style="fill:var(--line)"/>
    <line x1="238" y1="146" x2="276" y2="146" style="stroke:var(--line);stroke-width:2"/><path d="M276,146 l-10,-5 l0,10 z" style="fill:var(--line)"/>
    <line x1="370" y1="146" x2="408" y2="146" style="stroke:var(--line);stroke-width:2"/><path d="M408,146 l-10,-5 l0,10 z" style="fill:var(--line)"/>
    <line x1="502" y1="146" x2="540" y2="146" style="stroke:var(--line);stroke-width:2"/><path d="M540,146 l-10,-5 l0,10 z" style="fill:var(--line)"/>
    <line x1="634" y1="146" x2="668" y2="146" style="stroke:var(--teal);stroke-width:2.5"/><path d="M668,146 l-11,-5 l0,10 z" style="fill:var(--teal)"/>
    <text x="700" y="138" text-anchor="middle" style="fill:var(--teal);font-weight:700">✓ pass</text>
    <text x="700" y="158" text-anchor="middle" style="fill:var(--muted)">queue &amp; run</text>
    <path d="M588,202 l0,28" style="stroke:var(--red);stroke-width:2.5"/><path d="M588,230 l-5,-11 l10,0 z" style="fill:var(--red)"/>
...
<div class="cols">
  <div class="col"><h4>ddQueue (DDL)</h4><p>data definition: create/drop collection, build index. Executed <strong>serially</strong>, keeping structural changes ordered and conflict-free.</p></div>
  <div class="col"><h4>dmQueue (DML)</h4><p>data writes: insert/delete/upsert. Must preserve <strong>order within a shard</strong>; concurrent but ordered.</p></div>
  <div class="col"><h4>dqQueue (DQL)</h4><p>data queries: search/query. <strong>Read-heavy, highly concurrent</strong>, not blocking writes — each runs its own way.</p></div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="Proxy splits writes and reads into two paths: writes go to the WAL for ordered durability, reads fan out to shards and reduce into a global topK">
    <rect x="24" y="116" width="116" height="64" rx="11" style="fill:var(--panel);stroke:var(--accent);stroke-width:1.5"/>
    <text x="82" y="144" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">Proxy</text>
    <text x="82" y="164" text-anchor="middle" style="fill:var(--muted)">dispatch</text>
    <path d="M140,130 C170,130 172,80 200,80" style="fill:none;stroke:var(--amber);stroke-width:2.5"/><path d="M200,80 l-12,-5 l2,11 z" style="fill:var(--amber)"/>
    <rect x="202" y="58" width="160" height="44" rx="9" style="fill:var(--amber-soft);stroke:var(--amber)"/><text x="282" y="85" text-anchor="middle" style="fill:var(--amber);font-weight:700">WAL / MQ · by vchannel</text>
    <line x1="362" y1="80" x2="398" y2="80" style="stroke:var(--line);stroke-width:2"/><path d="M398,80 l-11,-5 l0,10 z" style="fill:var(--line)"/>
    <rect x="400" y="58" width="180" height="44" rx="9" style="fill:var(--panel);stroke:var(--teal);stroke-width:1.5"/><text x="490" y="85" text-anchor="middle" style="fill:var(--ink)">StreamingNode/DataNode flush</text>
    <text x="600" y="76" style="fill:var(--amber);font-weight:700">write</text><text x="600" y="94" style="fill:var(--muted)">ordered+durable</text>
    <path d="M140,166 C170,166 173,216 196,216" style="fill:none;stroke:var(--blue);stroke-width:2.5"/>
    <line x1="178" y1="216" x2="200" y2="196" style="stroke:var(--blue);stroke-width:1.5"/><path d="M200,196 l-11,2 l5,7 z" style="fill:var(--blue)"/>
    <line x1="178" y1="216" x2="200" y2="252" style="stroke:var(--blue);stroke-width:1.5"/><path d="M200,252 l-6,-9 l-3,10 z" style="fill:var(--blue)"/>
    <rect x="200" y="182" width="150" height="28" rx="7" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/><text x="275" y="201" text-anchor="middle" style="fill:var(--ink)">QueryNode shard ①</text>
    <rect x="200" y="216" width="150" height="28" rx="7" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/><text x="275" y="235" text-anchor="middle" style="fill:var(--ink)">QueryNode shard ②</text>
    <rect x="200" y="250" width="150" height="28" rx="7" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/><text x="275" y="269" text-anchor="middle" style="fill:var(--ink)">QueryNode shard ③</text>
    <line x1="350" y1="196" x2="430" y2="222" style="stroke:var(--blue);stroke-width:1.5"/>
    <line x1="350" y1="230" x2="430" y2="228" style="stroke:var(--blue);stroke-width:1.5"/>
    <line x1="350" y1="264" x2="430" y2="234" style="stroke:var(--blue);stroke-width:1.5"/>
    ...
    <line x1="582" y1="228" x2="616" y2="228" style="stroke:var(--accent);stroke-width:2"/><path d="M616,228 l-11,-5 l0,10 z" style="fill:var(--accent)"/>
    <text x="650" y="222" style="fill:var(--blue);font-weight:700">read</text><text x="650" y="240" style="fill:var(--muted)">concurrency+latency</text>
  </svg>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="TSO 是唯一的授时源：向多个 Proxy 发出全局唯一、单调递增的时间戳，并把高水位批量持久化到 etcd，崩溃也不回退">
    <rect x="280" y="70" width="200" height="76" rx="12" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="380" y="98" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">RootCoord · TSO 授时</text>
    <text x="380" y="122" text-anchor="middle" style="fill:var(--muted)">全局唯一 · 单调递增</text>
    <rect x="40" y="60" width="120" height="36" rx="8" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/><text x="100" y="83" text-anchor="middle" style="fill:var(--ink)">Proxy A</text>
    <rect x="40" y="112" width="120" height="36" rx="8" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/><text x="100" y="135" text-anchor="middle" style="fill:var(--ink)">Proxy B</text>
    <rect x="40" y="164" width="120" height="36" rx="8" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/><text x="100" y="187" text-anchor="middle" style="fill:var(--ink)">Proxy C</text>
    <line x1="278" y1="96" x2="164" y2="78" style="stroke:var(--accent);stroke-width:1.5"/><path d="M164,78 l11,-2 l-3,-9 z" style="fill:var(--accent)"/>
    <text x="208" y="74" class="mono" style="fill:var(--accent-ink)">ts=102</text>
    <line x1="278" y1="110" x2="164" y2="130" style="stroke:var(--accent);stroke-width:1.5"/><path d="M164,130 l11,2 l-4,9 z" style="fill:var(--accent)"/>
    <text x="208" y="118" class="mono" style="fill:var(--accent-ink)">ts=103</text>
    <line x1="278" y1="124" x2="164" y2="182" style="stroke:var(--accent);stroke-width:1.5"/><path d="M164,182 l10,3 l1,-11 z" style="fill:var(--accent)"/>
    <text x="208" y="162" class="mono" style="fill:var(--accent-ink)">ts=104</text>
    <rect x="560" y="74" width="172" height="68" rx="10" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/>
    <text x="646" y="100" text-anchor="middle" style="fill:var(--blue);font-weight:700">etcd · 高水位</text>
    ...
    <text x="486" y="96" style="fill:var(--muted)">周期持久化</text>
    <text x="40" y="226" style="fill:var(--muted)">发出的时间戳（只增不减）：</text>
    <rect x="240" y="208" width="54" height="30" rx="6" style="fill:var(--panel-2);stroke:var(--line)"/><text x="267" y="228" text-anchor="middle" class="mono" style="fill:var(--muted)">100</text>
    <rect x="300" y="208" width="54" height="30" rx="6" style="fill:var(--panel-2);stroke:var(--line)"/><text x="327" y="228" text-anchor="middle" class="mono" style="fill:var(--muted)">101</text>
    <rect x="360" y="208" width="54" height="30" rx="6" style="fill:var(--accent-soft);stroke:var(--accent)"/><text x="387" y="228" text-anchor="middle" class="mono" style="fill:var(--accent-ink)">102</text>
    <rect x="420" y="208" width="54" height="30" rx="6" style="fill:var(--accent-soft);stroke:var(--accent)"/><text x="447" y="228" text-anchor="middle" class="mono" style="fill:var(--accent-ink)">103</text>
    <rect x="480" y="208" width="54" height="30" rx="6" style="fill:var(--accent-soft);stroke:var(--accent)"/><text x="507" y="228" text-anchor="middle" class="mono" style="fill:var(--accent-ink)">104</text>
    <text x="548" y="228" style="fill:var(--teal);font-weight:700">→ 永不重复 / 倒退</text>
  </svg>
  <div class="figcap"><b>一个集群，唯一的时钟</b>：TSO 给并发取号的多个 Proxy 发出<b>全局唯一、单调递增</b>的时间戳（多在内存里瞬间完成）；只周期性把<b>高水位</b>持久化到 etcd——<b>崩溃重启也 ≥ 已发出的最大值，绝不倒退</b>。于是"比较时间戳大小"就等于"判断全局先后"。</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="TSO is the single time source: it issues globally unique, monotonically increasing timestamps to many Proxies and persists only a high-water mark to etcd, so it never regresses after a crash">
    <rect x="280" y="70" width="200" height="76" rx="12" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="380" y="98" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">RootCoord · TSO</text>
    <text x="380" y="122" text-anchor="middle" style="fill:var(--muted)">globally unique · monotonic</text>
    <rect x="40" y="60" width="120" height="36" rx="8" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/><text x="100" y="83" text-anchor="middle" style="fill:var(--ink)">Proxy A</text>
    <rect x="40" y="112" width="120" height="36" rx="8" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/><text x="100" y="135" text-anchor="middle" style="fill:var(--ink)">Proxy B</text>
    <rect x="40" y="164" width="120" height="36" rx="8" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/><text x="100" y="187" text-anchor="middle" style="fill:var(--ink)">Proxy C</text>
    <line x1="278" y1="96" x2="164" y2="78" style="stroke:var(--accent);stroke-width:1.5"/><path d="M164,78 l11,-2 l-3,-9 z" style="fill:var(--accent)"/>
    ...
    <rect x="408" y="208" width="54" height="30" rx="6" style="fill:var(--accent-soft);stroke:var(--accent)"/><text x="435" y="228" text-anchor="middle" class="mono" style="fill:var(--accent-ink)">102</text>
    <rect x="468" y="208" width="54" height="30" rx="6" style="fill:var(--accent-soft);stroke:var(--accent)"/><text x="495" y="228" text-anchor="middle" class="mono" style="fill:var(--accent-ink)">103</text>
    <rect x="528" y="208" width="54" height="30" rx="6" style="fill:var(--accent-soft);stroke:var(--accent)"/><text x="555" y="228" text-anchor="middle" class="mono" style="fill:var(--accent-ink)">104</text>
    <text x="596" y="228" style="fill:var(--teal);font-weight:700">→ never reused</text>
  </svg>
  <div class="figcap"><b>One cluster, one clock</b>: TSO hands many concurrently-requesting Proxies <b>globally unique, monotonically increasing</b> timestamps (mostly an instant in-memory op); it persists only a <b>high-water mark</b> to etcd — so after a crash it restarts <b>≥ the largest already issued, never regressing</b>. Comparing timestamps = ordering events globally.</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="段的状态机：Growing 到 Sealed 到 Flushing 到 Flushed 到 Dropped，每步由一个触发条件驱动；Flushed 起不可变、持久">
    <text x="139" y="72" text-anchor="middle" style="fill:var(--muted)">写满 / 超时</text>
    <text x="273" y="72" text-anchor="middle" style="fill:var(--muted)">刷盘</text>
    <text x="407" y="72" text-anchor="middle" style="fill:var(--muted)">落对象存储</text>
    <text x="541" y="72" text-anchor="middle" style="fill:var(--muted)">compaction</text>
    <rect x="20" y="80" width="104" height="64" rx="10" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/><text x="72" y="106" text-anchor="middle" style="fill:var(--blue);font-weight:700">Growing</text><text x="72" y="128" text-anchor="middle" style="fill:var(--muted)">内存·可变</text>
    <rect x="154" y="80" width="104" height="64" rx="10" style="fill:var(--panel);stroke:var(--purple);stroke-width:1.5"/><text x="206" y="106" text-anchor="middle" style="fill:var(--purple);font-weight:700">Sealed</text><text x="206" y="128" text-anchor="middle" style="fill:var(--muted)">封存·只读</text>
    <rect x="288" y="80" width="104" height="64" rx="10" style="fill:var(--panel);stroke:var(--amber);stroke-width:1.5"/><text x="340" y="106" text-anchor="middle" style="fill:var(--amber);font-weight:700">Flushing</text><text x="340" y="128" text-anchor="middle" style="fill:var(--muted)">写 binlog</text>
    <rect x="422" y="80" width="104" height="64" rx="10" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:2"/><text x="474" y="106" text-anchor="middle" style="fill:var(--teal);font-weight:700">★ Flushed</text><text x="474" y="128" text-anchor="middle" style="fill:var(--muted)">不可变·持久</text>
    <rect x="556" y="80" width="104" height="64" rx="10" style="fill:var(--panel-2);stroke:var(--line)"/><text x="608" y="106" text-anchor="middle" style="fill:var(--muted);font-weight:700">Dropped</text><text x="608" y="128" text-anchor="middle" style="fill:var(--faint)">等 GC</text>
    ...
    <line x1="392" y1="112" x2="420" y2="112" style="stroke:var(--line);stroke-width:2"/><path d="M420,112 l-10,-5 l0,10 z" style="fill:var(--line)"/>
    <line x1="526" y1="112" x2="554" y2="112" style="stroke:var(--line);stroke-width:2"/><path d="M554,112 l-10,-5 l0,10 z" style="fill:var(--line)"/>
    <path d="M20,166 L258,166" style="stroke:var(--blue);stroke-width:1.5"/><path d="M20,166 l0,-8 M258,166 l0,-8" style="stroke:var(--blue);stroke-width:1.5"/>
    <text x="139" y="186" text-anchor="middle" style="fill:var(--blue)">内存：节点挂 → 可能丢</text>
    <path d="M422,166 L526,166" style="stroke:var(--teal);stroke-width:1.5"/><path d="M422,166 l0,-8 M526,166 l0,-8" style="stroke:var(--teal);stroke-width:1.5"/>
    <text x="474" y="186" text-anchor="middle" style="fill:var(--teal)">对象存储：怎么挂都能恢复</text>
    <text x="380" y="222" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">★ 一旦 Flushed 即不可变：可被多个 QueryNode 安全加载 / 建索引 / 缓存</text>
  </svg>
  <div class="figcap"><b>段的一生：一台显式状态机</b>：<b>Growing</b>（内存可变）→ 写满/超时 → <b>Sealed</b> → 刷盘 → <b>Flushed</b>（落对象存储、<b>从此不可变</b>）→ compaction → <b>Dropped</b>。每一步 DataCoord 都落账到元数据——于是"我刚写的数据持久了吗"变成一个可精确回答的问题：相关段是否都已 Flushed。</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="A segment's state machine: Growing to Sealed to Flushing to Flushed to Dropped, each step driven by a trigger; from Flushed on it is immutable and durable">
    <text x="139" y="72" text-anchor="middle" style="fill:var(--muted)">full / timeout</text>
    ...
    <line x1="526" y1="112" x2="554" y2="112" style="stroke:var(--line);stroke-width:2"/><path d="M554,112 l-10,-5 l0,10 z" style="fill:var(--line)"/>
    <path d="M20,166 L258,166" style="stroke:var(--blue);stroke-width:1.5"/><path d="M20,166 l0,-8 M258,166 l0,-8" style="stroke:var(--blue);stroke-width:1.5"/>
    <text x="139" y="186" text-anchor="middle" style="fill:var(--blue)">memory: node dies → may be lost</text>
    <path d="M422,166 L526,166" style="stroke:var(--teal);stroke-width:1.5"/><path d="M422,166 l0,-8 M526,166 l0,-8" style="stroke:var(--teal);stroke-width:1.5"/>
    <text x="474" y="186" text-anchor="middle" style="fill:var(--teal)">object store: recoverable</text>
    <text x="380" y="222" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">★ from Flushed on it is immutable: safely loaded by many QueryNodes / indexed / cached</text>
  </svg>
  <div class="figcap"><b>A segment's life: an explicit state machine</b>: <b>Growing</b> (mutable in memory) → full/timeout → <b>Sealed</b> → flush → <b>Flushed</b> (in object storage, <b>now immutable</b>) → compaction → <b>Dropped</b>. DataCoord records each step in metadata — so "is my just-written data durable?" becomes a precise question: are the relevant segments all Flushed.</div>
</div>
...
<div class="flow">
  <div class="node"><div class="nt">一个集合</div><div class="nd">加载 N 个副本</div></div>
  <div class="arrow">各加载一份</div>
  <div class="node hl"><div class="nt">副本 1（节点 A·B）</div><div class="nd">同一批段的一份拷贝</div></div>
  <div class="node hl"><div class="nt">副本 2（节点 C·D）</div><div class="nd">另一份拷贝，独立服务</div></div>
  <div class="arrow">并行分担</div>
  <div class="node"><div class="nt">高可用 + 高吞吐</div><div class="nd">一个挂了另一个顶上；查询翻倍</div></div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="QueryCoordV2 的核心循环：观测者不断比对实际分布与期望目标，发现差距就生成加载或释放动作，让分布向目标收敛，永不停歇">
    <rect x="36" y="50" width="300" height="150" rx="11" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="52" y="74" style="fill:var(--ink);font-weight:700">① 分布 distribution（实际）</text>
    <rect x="52" y="86" width="268" height="30" rx="6" style="fill:var(--panel);stroke:var(--line)"/><text x="64" y="106" class="mono" style="fill:var(--ink)">Node1 ▸ segA · segB</text>
    <rect x="52" y="122" width="268" height="30" rx="6" style="fill:var(--panel);stroke:var(--line)"/><text x="64" y="142" class="mono" style="fill:var(--ink)">Node2 ▸ segD</text>
    <rect x="52" y="158" width="268" height="30" rx="6" style="fill:var(--panel);stroke:var(--red)"/><text x="64" y="178" class="mono" style="fill:var(--red)">✗ segC 未加载</text>
    <rect x="424" y="50" width="300" height="150" rx="11" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="440" y="74" style="fill:var(--accent-ink);font-weight:700">② 目标 target（期望）</text>
    <rect x="440" y="86" width="268" height="30" rx="6" style="fill:var(--panel);stroke:var(--line)"/><text x="452" y="106" class="mono" style="fill:var(--ink)">Node1 ▸ segA · segB</text>
    <rect x="440" y="122" width="268" height="30" rx="6" style="fill:var(--panel);stroke:var(--line)"/><text x="452" y="142" class="mono" style="fill:var(--ink)">Node2 ▸ segD</text>
    <rect x="440" y="158" width="268" height="30" rx="6" style="fill:var(--panel);stroke:var(--teal)"/><text x="452" y="178" class="mono" style="fill:var(--teal)">✓ Node3 ▸ segC</text>
    <text x="380" y="130" text-anchor="middle" style="fill:var(--amber);font-weight:700;font-size:26px">≠</text>
    <rect x="150" y="236" width="460" height="44" rx="10" style="fill:var(--panel);stroke:var(--accent);stroke-width:1.5"/>
    <text x="380" y="263" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">③ observer 比对差距 → 生成动作：加载 segC 到 Node3</text>
    <line x1="186" y1="200" x2="224" y2="234" style="stroke:var(--line);stroke-width:1.5"/><path d="M224,234 l-11,-3 l2,-9 z" style="fill:var(--line)"/>
    <line x1="560" y1="200" x2="536" y2="234" style="stroke:var(--line);stroke-width:1.5"/><path d="M536,234 l-2,-11 l9,3 z" style="fill:var(--line)"/>
    <path d="M150,258 C72,258 36,232 36,202" style="fill:none;stroke:var(--teal);stroke-width:2;stroke-dasharray:5 4"/><path d="M36,202 l-5,11 l10,0 z" style="fill:var(--teal)"/>
    <text x="40" y="224" style="fill:var(--teal);font-weight:700">分布向目标收敛 ↻</text>
  </svg>
  <div class="figcap"><b>声明终态，持续校正</b>：QueryCoordV2 把状态拆成<b>分布（实际）</b>与<b>目标（期望）</b>两张视图；observer 不断比对，发现差距（segC 缺失）就生成<b>加载 / 释放</b>动作，让分布<b>向目标收敛</b>——和 Kubernetes 的 reconcile 同理：只声明想要的终态，系统一轮轮自己逼近，永不停歇。</div>
</div>
...
<div class="flow">
  <div class="node"><div class="nt">one collection</div><div class="nd">loaded with N replicas</div></div>
  <div class="arrow">load once each</div>
  <div class="node hl"><div class="nt">replica 1 (nodes A·B)</div><div class="nd">one copy of the same segments</div></div>
  <div class="node hl"><div class="nt">replica 2 (nodes C·D)</div><div class="nd">another copy, serving independently</div></div>
  <div class="arrow">share in parallel</div>
  <div class="node"><div class="nt">HA + throughput</div><div class="nd">one dies, another takes over; ~2× queries</div></div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="QueryCoordV2's core loop: observers continuously compare the actual distribution against the desired target and emit load or release actions so the distribution converges to the target, never stopping">
    <rect x="36" y="50" width="300" height="150" rx="11" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="52" y="74" style="fill:var(--ink);font-weight:700">① distribution (actual)</text>
    <rect x="52" y="86" width="268" height="30" rx="6" style="fill:var(--panel);stroke:var(--line)"/><text x="64" y="106" class="mono" style="fill:var(--ink)">Node1 ▸ segA · segB</text>
    <rect x="52" y="122" width="268" height="30" rx="6" style="fill:var(--panel);stroke:var(--line)"/><text x="64" y="142" class="mono" style="fill:var(--ink)">Node2 ▸ segD</text>
    <rect x="52" y="158" width="268" height="30" rx="6" style="fill:var(--panel);stroke:var(--red)"/><text x="64" y="178" class="mono" style="fill:var(--red)">✗ segC not loaded</text>
    <rect x="424" y="50" width="300" height="150" rx="11" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="440" y="74" style="fill:var(--accent-ink);font-weight:700">② target (desired)</text>
    <rect x="440" y="86" width="268" height="30" rx="6" style="fill:var(--panel);stroke:var(--line)"/><text x="452" y="106" class="mono" style="fill:var(--ink)">Node1 ▸ segA · segB</text>
    <rect x="440" y="122" width="268" height="30" rx="6" style="fill:var(--panel);stroke:var(--line)"/><text x="452" y="142" class="mono" style="fill:var(--ink)">Node2 ▸ segD</text>
    <rect x="440" y="158" width="268" height="30" rx="6" style="fill:var(--panel);stroke:var(--teal)"/><text x="452" y="178" class="mono" style="fill:var(--teal)">✓ Node3 ▸ segC</text>
    <text x="380" y="130" text-anchor="middle" style="fill:var(--amber);font-weight:700;font-size:26px">≠</text>
    <rect x="150" y="236" width="460" height="44" rx="10" style="fill:var(--panel);stroke:var(--accent);stroke-width:1.5"/>
    <text x="380" y="263" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">③ observer diffs the gap → action: load segC onto Node3</text>
    <line x1="186" y1="200" x2="224" y2="234" style="stroke:var(--line);stroke-width:1.5"/><path d="M224,234 l-11,-3 l2,-9 z" style="fill:var(--line)"/>
    <line x1="560" y1="200" x2="536" y2="234" style="stroke:var(--line);stroke-width:1.5"/><path d="M536,234 l-2,-11 l9,3 z" style="fill:var(--line)"/>
    <path d="M150,258 C72,258 36,232 36,202" style="fill:none;stroke:var(--teal);stroke-width:2;stroke-dasharray:5 4"/><path d="M36,202 l-5,11 l10,0 z" style="fill:var(--teal)"/>
    <text x="40" y="224" style="fill:var(--teal);font-weight:700">distribution converges to target ↻</text>
  </svg>
  <div class="figcap"><b>Declare the end state, keep correcting</b>: QueryCoordV2 splits state into <b>distribution (actual)</b> and <b>target (desired)</b>; an observer keeps comparing them, and on a gap (segC missing) emits <b>load / release</b> actions so the distribution <b>converges to the target</b> — exactly like Kubernetes reconcile: you declare the end state, the system iterates toward it, never stopping.</div>
</div>
...
<div class="vflow">
  <div class="step"><div class="num">1</div><div class="sc"><h4>收到 DDL</h4><p>RootCoord 收到 <span class="mono">CreateCollection</span>，校验 schema、分配 collectionID。</p></div></div>
  <div class="step"><div class="num">2</div><div class="sc"><h4>调业务动词</h4><p>调 <span class="mono">Catalog.CreateCollection</span>——只说"建集合"，不碰存储细节。</p></div></div>
  <div class="step"><div class="num">3</div><div class="sc"><h4>降到 kv 原语</h4><p>Catalog 把对象序列化成 key/value，调 <span class="mono">kv.Save/MultiSave</span>。</p></div></div>
  <div class="step"><div class="num">4</div><div class="sc"><h4>真正落地</h4><p>kv 把字节写进 <strong>etcd</strong>（强一致、可 watch）；大文件改放对象存储、只留引用。</p></div></div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="etcd 是协调中枢：协调者用事务写权威元数据并 watch 变更，节点注册带租约的 session；真正的数据流量点对点直连，绝不经过 etcd">
    <rect x="70" y="38" width="150" height="44" rx="9" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/><text x="145" y="65" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">RootCoord</text>
    <rect x="305" y="38" width="150" height="44" rx="9" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/><text x="380" y="65" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">DataCoord</text>
    <rect x="540" y="38" width="150" height="44" rx="9" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/><text x="615" y="65" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">QueryCoord</text>
    <ellipse cx="380" cy="118" rx="58" ry="14" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <path d="M322,118 L322,184 A58,14 0 0 0 438,184 L438,118" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="380" y="150" text-anchor="middle" style="fill:var(--blue);font-weight:700">etcd</text>
    <text x="380" y="170" text-anchor="middle" style="fill:var(--muted)">唯一真相 + 通讯录</text>
    <line x1="322" y1="84" x2="352" y2="110" style="stroke:var(--accent);stroke-width:2"/><path d="M352,110 l-11,-2 l2,-9 z" style="fill:var(--accent)"/>
    <text x="232" y="100" style="fill:var(--accent-ink)">写元数据·事务/CAS</text>
    <line x1="438" y1="110" x2="460" y2="84" style="stroke:var(--accent);stroke-width:2;stroke-dasharray:4 3"/><path d="M460,84 l-2,11 l9,-5 z" style="fill:var(--accent)"/>
    <text x="470" y="100" style="fill:var(--muted)">watch 变更</text>
    <rect x="70" y="240" width="150" height="44" rx="9" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/><text x="145" y="267" text-anchor="middle" style="fill:var(--teal);font-weight:700">Proxy</text>
    <rect x="305" y="240" width="150" height="44" rx="9" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/><text x="380" y="267" text-anchor="middle" style="fill:var(--teal);font-weight:700">QueryNode</text>
    <rect x="540" y="240" width="150" height="44" rx="9" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/><text x="615" y="267" text-anchor="middle" style="fill:var(--teal);font-weight:700">DataNode</text>
    <line x1="380" y1="238" x2="380" y2="190" style="stroke:var(--teal);stroke-width:2"/><path d="M380,190 l-5,11 l10,0 z" style="fill:var(--teal)"/>
    <text x="392" y="216" style="fill:var(--teal)">注册 session（lease + keepalive）</text>
    <text x="497" y="232" text-anchor="middle" style="fill:var(--ink)">数据直连</text>
    <line x1="457" y1="262" x2="538" y2="262" style="stroke:var(--ink);stroke-width:4"/><path d="M538,262 l-12,-6 l0,12 z" style="fill:var(--ink)"/>
  </svg>
  <div class="figcap"><b>etcd：全集群的协调中枢</b>：协调者用<b>事务/CAS</b> 写权威元数据、<b>watch</b> 监听变更；节点用<b>带租约的 session</b>（持续 keepalive，崩了即自动删）注册自己。但<b>真正的 search/insert 数据流量是节点间点对点直连，绝不经过 etcd</b>——控制走 etcd、数据走直连，这条分界贯穿整个 Milvus。</div>
</div>
...
<div class="flow">
  <div class="node"><div class="nt">节点 Register()</div><div class="nd">写带租约 session：我是谁、地址、还活着</div></div>
  <div class="arrow">keepalive 续约</div>
  <div class="node hl"><div class="nt">etcd session 目录</div><div class="nd">活着→续约；崩了→租约到期自动删除</div></div>
  <div class="arrow">WatchServices</div>
  <div class="node"><div class="nt">协调者</div><div class="nd">收上线/掉线事件 → 握有当前活节点清单</div></div>
</div>
...
再上 <span class="mono">MetaKv</span> 加了 <span class="mono">CompareVersionAndSwap</span>（按版本做乐观锁）。最上 <span class="mono">WatchKV</span> 加了 <span class="mono">Watch</span>——这正是服务发现与"派活"机制的底座。</p>
...
<span class="kw">type</span> MetaKv <span class="kw">interface</span> { TxnKV; CompareVersionAndSwap(...) }  <span class="cm">// +CAS（版本乐观锁）</span>
...
<div class="card key">
  ...
  <ul>
    ...
    <li><strong>kv 层</strong>：<span class="mono">pkg/kv/kv.go</span> 逐层叠加 <span class="mono">BaseKV → TxnKV → MetaKv → WatchKV</span>（增删查 → 事务 → CAS/版本 → 监听），实现在 <span class="mono">internal/kv/etcd</span>。</li>
...
<div class="vflow">
  <div class="step"><div class="num">1</div><div class="sc"><h4>Receive DDL</h4><p>RootCoord gets <span class="mono">CreateCollection</span>, validates the schema, allocates a collectionID.</p></div></div>
  <div class="step"><div class="num">2</div><div class="sc"><h4>Call a business verb</h4><p>calls <span class="mono">Catalog.CreateCollection</span> — it only says "create a collection", untouched by storage details.</p></div></div>
  <div class="step"><div class="num">3</div><div class="sc"><h4>Lower to kv primitives</h4><p>Catalog serializes the object into key/values and calls <span class="mono">kv.Save/MultiSave</span>.</p></div></div>
  <div class="step"><div class="num">4</div><div class="sc"><h4>Real landing</h4><p>kv writes the bytes into <strong>etcd</strong> (strongly consistent, watchable); bulky files go to object storage, keeping only a reference.</p></div></div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="etcd is the coordination hub: coordinators write authoritative metadata by transaction and watch for changes, nodes register leased sessions; real data traffic is point-to-point and never goes through etcd">
    <rect x="70" y="38" width="150" height="44" rx="9" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/><text x="145" y="65" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">RootCoord</text>
    <rect x="305" y="38" width="150" height="44" rx="9" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/><text x="380" y="65" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">DataCoord</text>
    <rect x="540" y="38" width="150" height="44" rx="9" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/><text x="615" y="65" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">QueryCoord</text>
    <ellipse cx="380" cy="118" rx="58" ry="14" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <path d="M322,118 L322,184 A58,14 0 0 0 438,184 L438,118" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="380" y="150" text-anchor="middle" style="fill:var(--blue);font-weight:700">etcd</text>
    <text x="380" y="170" text-anchor="middle" style="fill:var(--muted)">truth + directory</text>
    <line x1="322" y1="84" x2="352" y2="110" style="stroke:var(--accent);stroke-width:2"/><path d="M352,110 l-11,-2 l2,-9 z" style="fill:var(--accent)"/>
    <text x="242" y="100" style="fill:var(--accent-ink)">write metadata · txn/CAS</text>
    <line x1="438" y1="110" x2="460" y2="84" style="stroke:var(--accent);stroke-width:2;stroke-dasharray:4 3"/><path d="M460,84 l-2,11 l9,-5 z" style="fill:var(--accent)"/>
    <text x="470" y="100" style="fill:var(--muted)">watch</text>
    <rect x="70" y="240" width="150" height="44" rx="9" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/><text x="145" y="267" text-anchor="middle" style="fill:var(--teal);font-weight:700">Proxy</text>
    <rect x="305" y="240" width="150" height="44" rx="9" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/><text x="380" y="267" text-anchor="middle" style="fill:var(--teal);font-weight:700">QueryNode</text>
    <rect x="540" y="240" width="150" height="44" rx="9" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/><text x="615" y="267" text-anchor="middle" style="fill:var(--teal);font-weight:700">DataNode</text>
    <line x1="380" y1="238" x2="380" y2="190" style="stroke:var(--teal);stroke-width:2"/><path d="M380,190 l-5,11 l10,0 z" style="fill:var(--teal)"/>
    <text x="392" y="216" style="fill:var(--teal)">register session (lease + keepalive)</text>
    <text x="497" y="232" text-anchor="middle" style="fill:var(--ink)">direct</text>
    <line x1="457" y1="262" x2="538" y2="262" style="stroke:var(--ink);stroke-width:4"/><path d="M538,262 l-12,-6 l0,12 z" style="fill:var(--ink)"/>
  </svg>
  <div class="figcap"><b>etcd: the cluster's coordination hub</b>: coordinators write authoritative metadata by <b>transaction/CAS</b> and <b>watch</b> for changes; nodes register a <b>leased session</b> (kept alive by keepalive, auto-deleted on crash). But the real <b>search/insert traffic is point-to-point between nodes and never touches etcd</b> — control through etcd, data direct: a divide that runs through all of Milvus.</div>
</div>
...
<div class="flow">
<div class="node"><div class="nt">node Register()</div><div class="nd">write a leased session: who/address/alive</div></div>
<div class="arrow">keepalive</div>
<div class="node hl"><div class="nt">etcd session dir</div><div class="nd">alive→renew; crashed→lease expires, auto-deleted</div></div>
<div class="arrow">WatchServices</div>
<div class="node"><div class="nt">coordinator</div><div class="nd">gets up/down events → holds the live-node list</div></div>
</div>
...
Above that, <span class="mono">MetaKv</span> adds <span class="mono">CompareVersionAndSwap</span> (version-based optimistic locking). At the top, <span class="mono">WatchKV</span> adds <span class="mono">Watch</span> — the very foundation of service discovery and the "assign work" mechanism.</p>
...
<span class="kw">type</span> MetaKv <span class="kw">interface</span> { TxnKV; CompareVersionAndSwap(...) }  <span class="cm">// +CAS (version)</span>
...
<div class="card key">
  ...
  <ul>
    ...
    <li><strong>kv layer</strong>: <span class="mono">pkg/kv/kv.go</span> stacks <span class="mono">BaseKV → TxnKV → MetaKv → WatchKV</span> (CRUD → transactions → CAS/version → watch), implemented in <span class="mono">internal/kv/etcd</span>.</li>

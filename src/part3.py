...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="Proxy 把写和读分成两条路：写沿 WAL 顺序持久化，读扇出到各分片再归并成全局 topK">
    ...
    <rect x="202" y="58" width="160" height="44" rx="9" style="fill:var(--amber-soft);stroke:var(--amber)"/><text x="282" y="85" text-anchor="middle" style="fill:var(--amber);font-weight:700">WAL / MQ</text>
    <line x1="362" y1="80" x2="398" y2="80" style="stroke:var(--line);stroke-width:2"/><path d="M398,80 l-11,-5 l0,10 z" style="fill:var(--line)"/>
    <rect x="400" y="58" width="180" height="44" rx="9" style="fill:var(--panel);stroke:var(--teal);stroke-width:1.5"/><text x="490" y="85" text-anchor="middle" style="fill:var(--ink)">DataNode 落盘</text>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="Proxy splits writes and reads into two paths: writes go to the WAL for ordered durability, reads fan out to shards and reduce into a global topK">
    ...
    <rect x="202" y="58" width="160" height="44" rx="9" style="fill:var(--amber-soft);stroke:var(--amber)"/><text x="282" y="85" text-anchor="middle" style="fill:var(--amber);font-weight:700">WAL / MQ</text>
    <line x1="362" y1="80" x2="398" y2="80" style="stroke:var(--line);stroke-width:2"/><path d="M398,80 l-11,-5 l0,10 z" style="fill:var(--line)"/>
    <rect x="400" y="58" width="180" height="44" rx="9" style="fill:var(--panel);stroke:var(--teal);stroke-width:1.5"/><text x="490" y="85" text-anchor="middle" style="fill:var(--ink)">DataNode flush</text>

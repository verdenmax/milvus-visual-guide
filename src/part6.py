...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="一次 search 的往返：SDK 发请求，Proxy 的 searchTask 解析建计划定时间戳、扇出到各分片、再归并，结果返回 SDK">
    ...
    <rect x="160" y="140" width="206" height="30" rx="6" style="fill:var(--panel);stroke:var(--accent)"/><text x="263" y="160" text-anchor="middle" style="fill:var(--accent-ink)">② Execute · 扇出 scatter</text>
    <rect x="160" y="174" width="206" height="30" rx="6" style="fill:var(--panel);stroke:var(--teal)"/><text x="263" y="194" text-anchor="middle" style="fill:var(--teal)">③ PostExecute · 归并 reduce</text>
    <line x1="114" y1="132" x2="144" y2="132" style="stroke:var(--line);stroke-width:2"/><path d="M144,132 l-10,-5 l0,10 z" style="fill:var(--line)"/>
    <text x="129" y="124" text-anchor="middle" style="fill:var(--muted)">RPC</text>
    <path d="M146,206 C110,206 92,194 92,178" style="fill:none;stroke:var(--teal);stroke-width:1.5;stroke-dasharray:4 3"/><path d="M92,178 l-5,11 l10,0 z" style="fill:var(--teal)"/>
    <text x="96" y="206" style="fill:var(--teal)">结果返回</text>
    <rect x="440" y="72" width="170" height="40" rx="8" style="fill:var(--panel);stroke:var(--accent);stroke-width:1.5"/><text x="525" y="97" text-anchor="middle" style="fill:var(--ink)">delegator A · 局部 topK</text>
    <rect x="440" y="120" width="170" height="40" rx="8" style="fill:var(--panel);stroke:var(--accent);stroke-width:1.5"/><text x="525" y="145" text-anchor="middle" style="fill:var(--ink)">delegator B · 局部 topK</text>
    <rect x="440" y="168" width="170" height="40" rx="8" style="fill:var(--panel);stroke:var(--accent);stroke-width:1.5"/><text x="525" y="193" text-anchor="middle" style="fill:var(--ink)">delegator C · 局部 topK</text>
    <line x1="380" y1="151" x2="438" y2="92" style="stroke:var(--accent);stroke-width:1.5"/><path d="M438,92 l-11,2 l4,8 z" style="fill:var(--accent)"/>
    <line x1="380" y1="153" x2="438" y2="140" style="stroke:var(--accent);stroke-width:1.5"/><path d="M438,140 l-11,-1 l3,9 z" style="fill:var(--accent)"/>
    <line x1="380" y1="155" x2="438" y2="188" style="stroke:var(--accent);stroke-width:1.5"/><path d="M438,188 l-10,-4 l-1,9 z" style="fill:var(--accent)"/>
    <line x1="438" y1="108" x2="382" y2="186" style="stroke:var(--teal);stroke-width:1.5;stroke-dasharray:4 3"/>
    <line x1="438" y1="156" x2="382" y2="189" style="stroke:var(--teal);stroke-width:1.5;stroke-dasharray:4 3"/>
    <line x1="620" y1="92" x2="700" y2="92" style="stroke:var(--line);stroke-width:1;stroke-dasharray:3 3"/><text x="708" y="96" style="fill:var(--faint)">↘ 段</text>
    <text x="380" y="232" text-anchor="middle" style="fill:var(--muted)">外层：Proxy 扇到分片；内层：分片再扇到段（第26课）· 并发，最慢分片定延迟</text>
  </svg>
  <div class="figcap"><b>一次 search 的往返与两层扇出</b>：Proxy 把请求封成 <span class="mono">searchTask</span>——<b>① 解析建 plan、定 guarantee ts → ② 扇出到各分片 delegator → ③ 归并出全局 topK</b> 返回 SDK。扇出是<b>两层</b>的（Proxy→分片，分片→段），且<b>并发</b>进行——一次搜索的延迟取决于<b>最慢的那个分片</b>，而非所有分片之和。</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="A search round-trip: the SDK sends a request, the Proxy's searchTask parses and builds a plan and timestamp, scatters to the shards, then reduces, and the result returns to the SDK">
    ...
    <text x="263" y="96" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">Proxy · searchTask</text>
    <rect x="160" y="106" width="206" height="30" rx="6" style="fill:var(--panel);stroke:var(--line)"/><text x="263" y="126" text-anchor="middle" style="fill:var(--ink)">① PreExecute · plan + ts</text>
    <rect x="160" y="140" width="206" height="30" rx="6" style="fill:var(--panel);stroke:var(--accent)"/><text x="263" y="160" text-anchor="middle" style="fill:var(--accent-ink)">② Execute · scatter</text>
    <rect x="160" y="174" width="206" height="30" rx="6" style="fill:var(--panel);stroke:var(--teal)"/><text x="263" y="194" text-anchor="middle" style="fill:var(--teal)">③ PostExecute · reduce</text>
    <line x1="114" y1="132" x2="144" y2="132" style="stroke:var(--line);stroke-width:2"/><path d="M144,132 l-10,-5 l0,10 z" style="fill:var(--line)"/>
    <text x="129" y="124" text-anchor="middle" style="fill:var(--muted)">RPC</text>
    <path d="M146,206 C110,206 92,194 92,178" style="fill:none;stroke:var(--teal);stroke-width:1.5;stroke-dasharray:4 3"/><path d="M92,178 l-5,11 l10,0 z" style="fill:var(--teal)"/>
    <text x="96" y="206" style="fill:var(--teal)">result</text>
    <rect x="440" y="72" width="170" height="40" rx="8" style="fill:var(--panel);stroke:var(--accent);stroke-width:1.5"/><text x="525" y="97" text-anchor="middle" style="fill:var(--ink)">delegator A · local topK</text>
    <rect x="440" y="120" width="170" height="40" rx="8" style="fill:var(--panel);stroke:var(--accent);stroke-width:1.5"/><text x="525" y="145" text-anchor="middle" style="fill:var(--ink)">delegator B · local topK</text>
    <rect x="440" y="168" width="170" height="40" rx="8" style="fill:var(--panel);stroke:var(--accent);stroke-width:1.5"/><text x="525" y="193" text-anchor="middle" style="fill:var(--ink)">delegator C · local topK</text>
    <line x1="380" y1="151" x2="438" y2="92" style="stroke:var(--accent);stroke-width:1.5"/><path d="M438,92 l-11,2 l4,8 z" style="fill:var(--accent)"/>
    <line x1="380" y1="153" x2="438" y2="140" style="stroke:var(--accent);stroke-width:1.5"/><path d="M438,140 l-11,-1 l3,9 z" style="fill:var(--accent)"/>
    <line x1="380" y1="155" x2="438" y2="188" style="stroke:var(--accent);stroke-width:1.5"/><path d="M438,188 l-10,-4 l-1,9 z" style="fill:var(--accent)"/>
    <line x1="438" y1="108" x2="382" y2="186" style="stroke:var(--teal);stroke-width:1.5;stroke-dasharray:4 3"/>
    <line x1="438" y1="156" x2="382" y2="189" style="stroke:var(--teal);stroke-width:1.5;stroke-dasharray:4 3"/>
    <line x1="620" y1="92" x2="700" y2="92" style="stroke:var(--line);stroke-width:1;stroke-dasharray:3 3"/><text x="708" y="96" style="fill:var(--faint)">↘ seg</text>
    <text x="380" y="232" text-anchor="middle" style="fill:var(--muted)">two-layer fan-out (Proxy→shards, shards→segments · L26) · concurrent: the slowest shard sets latency</text>
  </svg>
  <div class="figcap"><b>A search round-trip with two-layer fan-out</b>: the Proxy wraps the request into a <span class="mono">searchTask</span> — <b>① parse, build the plan, set the guarantee ts → ② scatter to each shard's delegator → ③ reduce into the global topK</b>, returned to the SDK. The fan-out is <b>two layers</b> (Proxy→shards, shards→segments) and runs <b>concurrently</b> — latency is set by the <b>slowest shard</b>, not the sum.</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="delegator 是分片读的唯一入口：消费 WAL 尾部保鲜 growing 段、扇出到持有 sealed 段的 worker QueryNode、再归并；维护 tsafe">
    <rect x="24" y="62" width="130" height="50" rx="9" style="fill:var(--amber-soft);stroke:var(--amber)"/><text x="89" y="84" text-anchor="middle" style="fill:var(--amber);font-weight:700">WAL 尾部</text><text x="89" y="103" text-anchor="middle" style="fill:var(--muted)">流式日志</text>
    <line x1="154" y1="87" x2="226" y2="87" style="stroke:var(--amber);stroke-width:2"/><path d="M226,87 l-11,-5 l0,10 z" style="fill:var(--amber)"/>
    <text x="190" y="79" text-anchor="middle" style="fill:var(--amber)">Tail 保鲜</text>
    <rect x="230" y="46" width="300" height="92" rx="11" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="380" y="70" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">delegator · shard leader（唯一入口）</text>
    <text x="380" y="90" text-anchor="middle" style="fill:var(--muted)">扇出 scatter · 归并 reduce · 维护 tsafe</text>
    <rect x="252" y="102" width="256" height="28" rx="6" style="fill:var(--panel);stroke:var(--blue)"/><text x="380" y="121" text-anchor="middle" style="fill:var(--blue)">growing 段（本地 · 暴力搜 · 最新）</text>
    <text x="380" y="172" text-anchor="middle" style="fill:var(--muted)">扇出 ↓　局部结果 ↑</text>
    <rect x="60" y="204" width="200" height="68" rx="10" style="fill:var(--panel);stroke:var(--teal);stroke-width:1.5"/><text x="160" y="232" text-anchor="middle" style="fill:var(--teal);font-weight:700">worker QueryNode</text><text x="160" y="254" text-anchor="middle" style="fill:var(--muted)">sealed 段 · segcore 检索</text>
    <rect x="280" y="204" width="200" height="68" rx="10" style="fill:var(--panel);stroke:var(--teal);stroke-width:1.5"/><text x="380" y="232" text-anchor="middle" style="fill:var(--teal);font-weight:700">worker QueryNode</text><text x="380" y="254" text-anchor="middle" style="fill:var(--muted)">sealed 段 · segcore 检索</text>
    <rect x="500" y="204" width="200" height="68" rx="10" style="fill:var(--panel);stroke:var(--teal);stroke-width:1.5"/><text x="600" y="232" text-anchor="middle" style="fill:var(--teal);font-weight:700">worker QueryNode</text><text x="600" y="254" text-anchor="middle" style="fill:var(--muted)">sealed 段 · segcore 检索</text>
    ...
    <line x1="210" y1="204" x2="338" y2="140" style="stroke:var(--teal);stroke-width:1.5;stroke-dasharray:4 3"/>
    <line x1="552" y1="204" x2="422" y2="140" style="stroke:var(--teal);stroke-width:1.5;stroke-dasharray:4 3"/>
  </svg>
  <div class="figcap"><b>分片读的唯一入口</b>：<b>delegator</b>（shard leader）只<b>协调</b>——扇出到各 worker、把局部结果<b>归并</b>、并维护 <span class="mono">tsafe</span>；它还亲自<b>消费 WAL 尾部</b>保鲜本地的 <b>growing 段</b>（最新数据）。真正在 <b>sealed 段</b>上<b>算距离</b>的是各 worker 的 <b>segcore</b>——和 Proxy"只协调不算"同构，只是下沉了一层。</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="The delegator is the shard's single read entry: it tails the WAL to keep the local growing segment fresh, scatters to worker QueryNodes holding sealed segments, then merges; it maintains tsafe">
    <rect x="24" y="62" width="130" height="50" rx="9" style="fill:var(--amber-soft);stroke:var(--amber)"/><text x="89" y="84" text-anchor="middle" style="fill:var(--amber);font-weight:700">WAL tail</text><text x="89" y="103" text-anchor="middle" style="fill:var(--muted)">stream log</text>
    <line x1="154" y1="87" x2="226" y2="87" style="stroke:var(--amber);stroke-width:2"/><path d="M226,87 l-11,-5 l0,10 z" style="fill:var(--amber)"/>
    <text x="190" y="79" text-anchor="middle" style="fill:var(--amber)">tail→fresh</text>
    <rect x="230" y="46" width="300" height="92" rx="11" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
  ...
  <div class="figcap"><b>The shard's single read entry</b>: the <b>delegator</b> (shard leader) only <b>coordinates</b> — scatters to workers, <b>merges</b> partials, maintains <span class="mono">tsafe</span>; and it personally <b>tails the WAL</b> to keep the local <b>growing segment</b> fresh (newest data). What actually <b>computes distances</b> on <b>sealed segments</b> is each worker's <b>segcore</b> — same shape as Proxy "coordinate, don't compute," one level lower.</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="segcore 用同一套 SegmentInterface 抽象一个段，底下两种实现：sealed 走索引、growing 暴力扫；并按删除位图与时间戳过滤后给出段内 topK">
    ...
    <line x1="318" y1="86" x2="226" y2="116" style="stroke:var(--accent);stroke-width:1.5"/><path d="M226,116 l2,-11 l7,7 z" style="fill:var(--accent)"/>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="过滤 price 小于 500 且 category 等于 shoes 被建成一棵表达式树：AND 根、两个比较节点、叶子是列与常量；自底向上求值，AND 按位与合并掩码">
    <text x="380" y="28" text-anchor="middle" style="fill:var(--muted)">price &lt; 500 &amp;&amp; category == "shoes"　→　表达式树</text>
    <line x1="362" y1="80" x2="250" y2="112" style="stroke:var(--line);stroke-width:1.5"/>
    <line x1="398" y1="80" x2="512" y2="112" style="stroke:var(--line);stroke-width:1.5"/>
    <line x1="212" y1="156" x2="172" y2="194" style="stroke:var(--line);stroke-width:1.5"/>
    <line x1="280" y1="156" x2="276" y2="194" style="stroke:var(--line);stroke-width:1.5"/>
    <line x1="490" y1="156" x2="490" y2="194" style="stroke:var(--line);stroke-width:1.5"/>
    <line x1="552" y1="156" x2="612" y2="194" style="stroke:var(--line);stroke-width:1.5"/>
    <rect x="338" y="40" width="84" height="40" rx="9" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/><text x="380" y="65" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">AND</text>
    <rect x="168" y="114" width="156" height="42" rx="9" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/><text x="246" y="140" text-anchor="middle" style="fill:var(--blue);font-weight:700">Compare ( &lt; )</text>
    <rect x="438" y="114" width="156" height="42" rx="9" style="fill:var(--panel);stroke:var(--blue);stroke-width:1.5"/><text x="516" y="140" text-anchor="middle" style="fill:var(--blue);font-weight:700">Compare ( == )</text>
    <rect x="112" y="196" width="118" height="40" rx="8" style="fill:var(--panel-2);stroke:var(--teal)"/><text x="171" y="221" text-anchor="middle" class="mono" style="fill:var(--teal)">col price</text>
    <rect x="240" y="196" width="74" height="40" rx="8" style="fill:var(--panel-2);stroke:var(--amber)"/><text x="277" y="221" text-anchor="middle" class="mono" style="fill:var(--amber)">500</text>
    <rect x="428" y="196" width="124" height="40" rx="8" style="fill:var(--panel-2);stroke:var(--teal)"/><text x="490" y="221" text-anchor="middle" class="mono" style="fill:var(--teal)">col category</text>
    <rect x="560" y="196" width="118" height="40" rx="8" style="fill:var(--panel-2);stroke:var(--amber)"/><text x="619" y="221" text-anchor="middle" class="mono" style="fill:var(--amber)">"shoes"</text>
    <text x="380" y="270" text-anchor="middle" style="fill:var(--muted)">自底向上：每个 Compare → 一列 bool；AND 把两列<tspan style="fill:var(--accent-ink);font-weight:700">按位与</tspan> → 最终 bitset 掩码</text>
  </svg>
  <div class="figcap"><b>把"一句话过滤"变成一棵树</b>：根是逻辑节点 <b>AND</b>，两个孩子是比较 <b>Compare(&lt;)</b>、<b>Compare(==)</b>，叶子是<b>列引用</b>（<span class="mono">price/category</span>）与<b>常量</b>（<span class="mono">500/"shoes"</span>）。求值<b>自底向上</b>：每个比较算出一列 bool，AND 再把两列<b>按位与</b>。解析只做一次、这棵树却被每段每块<b>反复复用</b>——这是把过滤跑到十亿行的第一步。</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="向量化执行：列式数据按块 chunk 处理，对一整块同列值做同一运算（SIMD），产出 bitset 掩码；不是一行一行算">
    <text x="40" y="38" style="fill:var(--muted)">price 列（列式 · 按块 chunk 切）</text>
    <rect x="40" y="48" width="180" height="40" rx="7" style="fill:var(--panel-2);stroke:var(--line)"/><text x="56" y="73" class="mono" style="fill:var(--muted)">chunk0 · 88 12 …</text>
    <rect x="40" y="96" width="180" height="46" rx="7" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:2"/><text x="130" y="114" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">chunk1（处理中）</text><text x="130" y="133" text-anchor="middle" class="mono" style="fill:var(--accent-ink)">300 910 450 1200</text>
    <rect x="40" y="150" width="180" height="40" rx="7" style="fill:var(--panel-2);stroke:var(--line)"/><text x="56" y="175" class="mono" style="fill:var(--muted)">chunk2 · 7 60 …</text>
    <line x1="220" y1="119" x2="264" y2="119" style="stroke:var(--accent);stroke-width:2.5"/><path d="M264,119 l-11,-5 l0,10 z" style="fill:var(--accent)"/>
    <rect x="266" y="94" width="220" height="50" rx="9" style="fill:var(--panel);stroke:var(--accent);stroke-width:1.5"/><text x="376" y="115" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">向量化算子 · price &lt; 500</text><text x="376" y="133" text-anchor="middle" style="fill:var(--muted)">SIMD：一条指令算多个值</text>
    <line x1="486" y1="119" x2="520" y2="119" style="stroke:var(--teal);stroke-width:2.5"/><path d="M520,119 l-11,-5 l0,10 z" style="fill:var(--teal)"/>
    <rect x="524" y="104" width="32" height="30" rx="5" style="fill:var(--teal-soft);stroke:var(--teal)"/><text x="540" y="125" text-anchor="middle" class="mono" style="fill:var(--teal)">1</text>
    <rect x="558" y="104" width="32" height="30" rx="5" style="fill:var(--panel-2);stroke:var(--line)"/><text x="574" y="125" text-anchor="middle" class="mono" style="fill:var(--faint)">0</text>
    <rect x="592" y="104" width="32" height="30" rx="5" style="fill:var(--teal-soft);stroke:var(--teal)"/><text x="608" y="125" text-anchor="middle" class="mono" style="fill:var(--teal)">1</text>
    <rect x="626" y="104" width="32" height="30" rx="5" style="fill:var(--panel-2);stroke:var(--line)"/><text x="642" y="125" text-anchor="middle" class="mono" style="fill:var(--faint)">0</text>
    <text x="591" y="156" text-anchor="middle" style="fill:var(--muted)">块内 bitset</text>
    <text x="380" y="220" text-anchor="middle" style="fill:var(--muted)">一次处理一块、按需流过 → 拼成整列 bitset；缓存友好、几乎无分支（对比逐行：慢）</text>
  </svg>
  <div class="figcap"><b>不是一行一行，而是一块一块地算</b>：数据按<b>列式分块（chunk）</b>存；执行引擎对<b>一整块里成百上千个同列的值</b>做同一运算（这里 <span class="mono">price&lt;500</span>），用 <span class="mono">SIMD</span> 一条指令算多个、缓存友好、几乎没有分支预测失败。每块产出一段 <b>bitset</b>，拼起来就是整列的过滤掩码——这正是把过滤"跑到十亿行还很快"的引擎底座。</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="The filter price less than 500 and category equals shoes becomes an expression tree: an AND root, two comparison nodes, leaves are columns and constants; evaluated bottom-up, AND bitwise-ANDs the masks">
    <text x="380" y="28" text-anchor="middle" style="fill:var(--muted)">price &lt; 500 &amp;&amp; category == "shoes"　→　expression tree</text>
    <line x1="362" y1="80" x2="250" y2="112" style="stroke:var(--line);stroke-width:1.5"/>
    <line x1="398" y1="80" x2="512" y2="112" style="stroke:var(--line);stroke-width:1.5"/>
    <line x1="212" y1="156" x2="172" y2="194" style="stroke:var(--line);stroke-width:1.5"/>
    <line x1="280" y1="156" x2="276" y2="194" style="stroke:var(--line);stroke-width:1.5"/>
    ...
    <rect x="428" y="196" width="124" height="40" rx="8" style="fill:var(--panel-2);stroke:var(--teal)"/><text x="490" y="221" text-anchor="middle" class="mono" style="fill:var(--teal)">col category</text>
    <rect x="560" y="196" width="118" height="40" rx="8" style="fill:var(--panel-2);stroke:var(--amber)"/><text x="619" y="221" text-anchor="middle" class="mono" style="fill:var(--amber)">"shoes"</text>
    <text x="380" y="270" text-anchor="middle" style="fill:var(--muted)">bottom-up: each Compare → a bool column; AND <tspan style="fill:var(--accent-ink);font-weight:700">bitwise-ANDs</tspan> the two → the final bitset mask</text>
  </svg>
  <div class="figcap"><b>Turn "a sentence of filter" into a tree</b>: the root is the logical <b>AND</b>, its children are <b>Compare(&lt;)</b> and <b>Compare(==)</b>, and the leaves are <b>column refs</b> (<span class="mono">price/category</span>) and <b>constants</b> (<span class="mono">500/"shoes"</span>). Evaluation is <b>bottom-up</b>: each compare yields a bool column, then AND <b>bitwise-ANDs</b> them. Parsed once, reused on every segment and chunk — step one to running a filter over a billion rows.</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="Vectorized execution: columnar data is processed chunk by chunk, running one operation over a whole chunk of same-column values (SIMD), producing a bitset mask; not row by row">
    <text x="40" y="38" style="fill:var(--muted)">price column (columnar · split into chunks)</text>
    <rect x="40" y="48" width="180" height="40" rx="7" style="fill:var(--panel-2);stroke:var(--line)"/><text x="56" y="73" class="mono" style="fill:var(--muted)">chunk0 · 88 12 …</text>
    <rect x="40" y="96" width="180" height="46" rx="7" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:2"/><text x="130" y="114" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">chunk1 (processing)</text><text x="130" y="133" text-anchor="middle" class="mono" style="fill:var(--accent-ink)">300 910 450 1200</text>
    <rect x="40" y="150" width="180" height="40" rx="7" style="fill:var(--panel-2);stroke:var(--line)"/><text x="56" y="175" class="mono" style="fill:var(--muted)">chunk2 · 7 60 …</text>
    <line x1="220" y1="119" x2="264" y2="119" style="stroke:var(--accent);stroke-width:2.5"/><path d="M264,119 l-11,-5 l0,10 z" style="fill:var(--accent)"/>
    <rect x="266" y="94" width="220" height="50" rx="9" style="fill:var(--panel);stroke:var(--accent);stroke-width:1.5"/><text x="376" y="115" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">vectorized op · price &lt; 500</text><text x="376" y="133" text-anchor="middle" style="fill:var(--muted)">SIMD · one op, many values</text>
    <line x1="486" y1="119" x2="520" y2="119" style="stroke:var(--teal);stroke-width:2.5"/><path d="M520,119 l-11,-5 l0,10 z" style="fill:var(--teal)"/>
    <rect x="524" y="104" width="32" height="30" rx="5" style="fill:var(--teal-soft);stroke:var(--teal)"/><text x="540" y="125" text-anchor="middle" class="mono" style="fill:var(--teal)">1</text>
    <rect x="558" y="104" width="32" height="30" rx="5" style="fill:var(--panel-2);stroke:var(--line)"/><text x="574" y="125" text-anchor="middle" class="mono" style="fill:var(--faint)">0</text>
    <rect x="592" y="104" width="32" height="30" rx="5" style="fill:var(--teal-soft);stroke:var(--teal)"/><text x="608" y="125" text-anchor="middle" class="mono" style="fill:var(--teal)">1</text>
    <rect x="626" y="104" width="32" height="30" rx="5" style="fill:var(--panel-2);stroke:var(--line)"/><text x="642" y="125" text-anchor="middle" class="mono" style="fill:var(--faint)">0</text>
    <text x="591" y="156" text-anchor="middle" style="fill:var(--muted)">chunk bitset</text>
    <text x="380" y="220" text-anchor="middle" style="fill:var(--muted)">one chunk at a time → assembled into the column's bitset (cache-friendly)</text>
  </svg>
  <div class="figcap"><b>Not row by row, but chunk by chunk</b>: data is stored <b>columnar, in chunks</b>; the engine runs one operation (here <span class="mono">price&lt;500</span>) over <b>hundreds-to-thousands of same-column values in a whole chunk</b> at once — <span class="mono">SIMD</span> does many per instruction, cache-friendly, almost no branch mispredicts. Each chunk yields a piece of <b>bitset</b>; stitched together they form the column's filter mask — the engine floor that keeps a filter fast over a billion rows.</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="三层归并的具体走一遍：6 个段各出 top3，两个分片各归并出 top3，Proxy 再归并出全局 top3；每层只上交 K 条">
    <rect x="250" y="44" width="260" height="56" rx="11" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:2"/><text x="380" y="68" text-anchor="middle" style="fill:var(--teal);font-weight:700">Proxy · 全局 top3</text><text x="380" y="89" text-anchor="middle" class="mono" style="fill:var(--ink)">0.05 · 0.08 · 0.12</text>
    <rect x="84" y="134" width="212" height="54" rx="10" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/><text x="190" y="157" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">分片 A · top3</text><text x="190" y="178" text-anchor="middle" class="mono" style="fill:var(--ink)">0.05 · 0.12 · 0.31</text>
    <rect x="464" y="134" width="212" height="54" rx="10" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/><text x="570" y="157" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">分片 B · top3</text><text x="570" y="178" text-anchor="middle" class="mono" style="fill:var(--ink)">0.08 · 0.20 · 0.40</text>
    <rect x="40" y="214" width="96" height="40" rx="8" style="fill:var(--panel);stroke:var(--line)"/><text x="88" y="239" text-anchor="middle" style="fill:var(--muted)">seg1 · top3</text>
    <rect x="142" y="214" width="96" height="40" rx="8" style="fill:var(--panel);stroke:var(--line)"/><text x="190" y="239" text-anchor="middle" style="fill:var(--muted)">seg2 · top3</text>
    <rect x="244" y="214" width="96" height="40" rx="8" style="fill:var(--panel);stroke:var(--line)"/><text x="292" y="239" text-anchor="middle" style="fill:var(--muted)">seg3 · top3</text>
    <rect x="420" y="214" width="96" height="40" rx="8" style="fill:var(--panel);stroke:var(--line)"/><text x="468" y="239" text-anchor="middle" style="fill:var(--muted)">seg4 · top3</text>
    <rect x="522" y="214" width="96" height="40" rx="8" style="fill:var(--panel);stroke:var(--line)"/><text x="570" y="239" text-anchor="middle" style="fill:var(--muted)">seg5 · top3</text>
    <rect x="624" y="214" width="96" height="40" rx="8" style="fill:var(--panel);stroke:var(--line)"/><text x="672" y="239" text-anchor="middle" style="fill:var(--muted)">seg6 · top3</text>
    <line x1="88" y1="214" x2="160" y2="190" style="stroke:var(--line);stroke-width:1.5"/><line x1="190" y1="214" x2="190" y2="190" style="stroke:var(--line);stroke-width:1.5"/><line x1="292" y1="214" x2="220" y2="190" style="stroke:var(--line);stroke-width:1.5"/>
    <line x1="468" y1="214" x2="540" y2="190" style="stroke:var(--line);stroke-width:1.5"/><line x1="570" y1="214" x2="570" y2="190" style="stroke:var(--line);stroke-width:1.5"/><line x1="672" y1="214" x2="600" y2="190" style="stroke:var(--line);stroke-width:1.5"/>
    <line x1="190" y1="134" x2="330" y2="102" style="stroke:var(--accent);stroke-width:2"/><path d="M330,102 l-11,1 l4,9 z" style="fill:var(--accent)"/>
    <line x1="570" y1="134" x2="430" y2="102" style="stroke:var(--accent);stroke-width:2"/><path d="M430,102 l-4,-10 l9,2 z" style="fill:var(--accent)"/>
    <text x="380" y="282" text-anchor="middle" style="fill:var(--muted)">每层去重、排序，只上交 top K=3 —— 网络上始终只流动 K 量级（与十亿总量无关）</text>
  </svg>
  <div class="figcap"><b>三层归并，走一遍</b>：6 个段各出 <b>top3</b> → 分片 A 把 seg1-3 归并成 <span class="mono">[0.05,0.12,0.31]</span>、分片 B 归并成 <span class="mono">[0.08,0.20,0.40]</span> → Proxy 再把这 6 条归并、去重、排序，取<b>全局 top3</b> <span class="mono">[0.05, 0.08, 0.12]</span>。每一层都只上交 <b>K 条</b>——网络上流动的<b>始终是 K 量级</b>，与底层有多少亿条数据无关。</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="A concrete walk-through of the three-level reduce: 6 segments each yield top3, two shards each merge to top3, and the Proxy merges to the global top3; each level passes only K rows up">
    <rect x="250" y="44" width="260" height="56" rx="11" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:2"/><text x="380" y="68" text-anchor="middle" style="fill:var(--teal);font-weight:700">Proxy · global top3</text><text x="380" y="89" text-anchor="middle" class="mono" style="fill:var(--ink)">0.05 · 0.08 · 0.12</text>
    <rect x="84" y="134" width="212" height="54" rx="10" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/><text x="190" y="157" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">shard A · top3</text><text x="190" y="178" text-anchor="middle" class="mono" style="fill:var(--ink)">0.05 · 0.12 · 0.31</text>
    <rect x="464" y="134" width="212" height="54" rx="10" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/><text x="570" y="157" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">shard B · top3</text><text x="570" y="178" text-anchor="middle" class="mono" style="fill:var(--ink)">0.08 · 0.20 · 0.40</text>
    <rect x="40" y="214" width="96" height="40" rx="8" style="fill:var(--panel);stroke:var(--line)"/><text x="88" y="239" text-anchor="middle" style="fill:var(--muted)">seg1 · top3</text>
    <rect x="142" y="214" width="96" height="40" rx="8" style="fill:var(--panel);stroke:var(--line)"/><text x="190" y="239" text-anchor="middle" style="fill:var(--muted)">seg2 · top3</text>
    <rect x="244" y="214" width="96" height="40" rx="8" style="fill:var(--panel);stroke:var(--line)"/><text x="292" y="239" text-anchor="middle" style="fill:var(--muted)">seg3 · top3</text>
    <rect x="420" y="214" width="96" height="40" rx="8" style="fill:var(--panel);stroke:var(--line)"/><text x="468" y="239" text-anchor="middle" style="fill:var(--muted)">seg4 · top3</text>
    ...
    <line x1="190" y1="134" x2="330" y2="102" style="stroke:var(--accent);stroke-width:2"/><path d="M330,102 l-11,1 l4,9 z" style="fill:var(--accent)"/>
    <line x1="570" y1="134" x2="430" y2="102" style="stroke:var(--accent);stroke-width:2"/><path d="M430,102 l-4,-10 l9,2 z" style="fill:var(--accent)"/>
    <text x="380" y="282" text-anchor="middle" style="fill:var(--muted)">each level keeps only top K=3 — the network always carries O(K)</text>
  </svg>
  <div class="figcap"><b>The three-level reduce, walked once</b>: 6 segments each yield <b>top3</b> → shard A merges seg1-3 to <span class="mono">[0.05,0.12,0.31]</span>, shard B to <span class="mono">[0.08,0.20,0.40]</span> → the Proxy merges, dedups, and sorts those 6 into the <b>global top3</b> <span class="mono">[0.05, 0.08, 0.12]</span>. Every level passes only <b>K rows</b> up — the network always carries <b>O(K)</b>, no matter how many billions sit underneath.</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="五种一致性级别是新鲜度与延迟之间的旋钮：Strong 最新但可能等，Bounded 默认几乎不等，Eventually 从不等可能略旧，Session 读自己刚写，Customized 指定时刻">
    <text x="380" y="34" text-anchor="middle" style="fill:var(--ink);font-weight:700">读带 guarantee ts（Tg）→ 节点比较 tsafe：≥Tg 立即答 ｜ &lt;Tg 就等到追上</text>
    <line x1="80" y1="158" x2="700" y2="158" style="stroke:var(--line);stroke-width:3"/>
    <path d="M80,158 l14,-6 l0,12 z" style="fill:var(--blue)"/><path d="M700,158 l-14,-6 l0,12 z" style="fill:var(--amber)"/>
    <line x1="130" y1="150" x2="130" y2="166" style="stroke:var(--accent);stroke-width:2"/><circle cx="130" cy="158" r="5" style="fill:var(--accent)"/>
    <text x="130" y="112" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">Strong</text><text x="130" y="132" text-anchor="middle" class="mono" style="fill:var(--muted)">Tg=tMax</text><text x="130" y="186" text-anchor="middle" style="fill:var(--muted)">最新·可能等</text>
    <line x1="300" y1="148" x2="300" y2="168" style="stroke:var(--teal);stroke-width:2"/><circle cx="300" cy="158" r="6" style="fill:var(--teal)"/>
    <text x="300" y="112" text-anchor="middle" style="fill:var(--teal);font-weight:700">Bounded ★默认</text><text x="300" y="132" text-anchor="middle" class="mono" style="fill:var(--muted)">tMax−gracefulTime</text><text x="300" y="186" text-anchor="middle" style="fill:var(--muted)">几乎不用等</text>
    <line x1="470" y1="150" x2="470" y2="166" style="stroke:var(--accent);stroke-width:2"/><circle cx="470" cy="158" r="5" style="fill:var(--accent)"/>
    <text x="470" y="112" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">Session</text><text x="470" y="132" text-anchor="middle" style="fill:var(--muted)">读到自己刚写</text>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="The five consistency levels are a knob between freshness and latency: Strong is freshest but may wait, Bounded is the default and barely waits, Eventually never waits and may be stale, Session reads your own writes, Customized picks a moment">
    <text x="380" y="28" text-anchor="middle" style="fill:var(--ink);font-weight:700">a read carries a guarantee ts (Tg)</text>
    <text x="380" y="48" text-anchor="middle" style="fill:var(--ink);font-weight:700">node compares tsafe: ≥Tg → answer now ｜ &lt;Tg → wait</text>
    <line x1="80" y1="158" x2="700" y2="158" style="stroke:var(--line);stroke-width:3"/>
    <path d="M80,158 l14,-6 l0,12 z" style="fill:var(--blue)"/><path d="M700,158 l-14,-6 l0,12 z" style="fill:var(--amber)"/>
    <line x1="130" y1="150" x2="130" y2="166" style="stroke:var(--accent);stroke-width:2"/><circle cx="130" cy="158" r="5" style="fill:var(--accent)"/>
    <text x="130" y="112" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">Strong</text><text x="130" y="132" text-anchor="middle" class="mono" style="fill:var(--muted)">Tg=tMax</text><text x="130" y="186" text-anchor="middle" style="fill:var(--muted)">freshest·may wait</text>
    <line x1="300" y1="148" x2="300" y2="168" style="stroke:var(--teal);stroke-width:2"/><circle cx="300" cy="158" r="6" style="fill:var(--teal)"/>
    <text x="300" y="112" text-anchor="middle" style="fill:var(--teal);font-weight:700">Bounded ★default</text><text x="300" y="132" text-anchor="middle" class="mono" style="fill:var(--muted)">tMax−gracefulTime</text><text x="300" y="186" text-anchor="middle" style="fill:var(--muted)">barely waits</text>
    <line x1="470" y1="150" x2="470" y2="166" style="stroke:var(--accent);stroke-width:2"/><circle cx="470" cy="158" r="5" style="fill:var(--accent)"/>
    <text x="470" y="112" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">Session</text><text x="470" y="132" text-anchor="middle" style="fill:var(--muted)">read your own writes</text>
    <line x1="650" y1="150" x2="650" y2="166" style="stroke:var(--accent);stroke-width:2"/><circle cx="650" cy="158" r="5" style="fill:var(--accent)"/>

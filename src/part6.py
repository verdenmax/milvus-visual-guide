...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="五种一致性级别是新鲜度与延迟之间的旋钮：Strong 最新但可能等，Bounded 默认几乎不等，Eventually 从不等可能略旧，Session 读自己刚写，Customized 指定时刻">
    ...
    <line x1="300" y1="150" x2="300" y2="166" style="stroke:var(--accent);stroke-width:2"/><circle cx="300" cy="158" r="5" style="fill:var(--accent)"/>
    <text x="300" y="112" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">Session</text><text x="300" y="132" text-anchor="middle" style="fill:var(--muted)">读到自己刚写</text>
    <line x1="470" y1="148" x2="470" y2="168" style="stroke:var(--teal);stroke-width:2"/><circle cx="470" cy="158" r="6" style="fill:var(--teal)"/>
    <text x="470" y="112" text-anchor="middle" style="fill:var(--teal);font-weight:700">Bounded ★默认</text><text x="470" y="132" text-anchor="middle" class="mono" style="fill:var(--muted)">tMax−gracefulTime</text><text x="470" y="186" text-anchor="middle" style="fill:var(--muted)">几乎不用等</text>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="The five consistency levels are a knob between freshness and latency: Strong is freshest but may wait, Bounded is the default and barely waits, Eventually never waits and may be stale, Session reads your own writes, Customized picks a moment">
    ...
    <line x1="300" y1="150" x2="300" y2="166" style="stroke:var(--accent);stroke-width:2"/><circle cx="300" cy="158" r="5" style="fill:var(--accent)"/>
    <text x="300" y="112" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700">Session</text><text x="300" y="132" text-anchor="middle" style="fill:var(--muted)">read your own writes</text>
    <line x1="470" y1="148" x2="470" y2="168" style="stroke:var(--teal);stroke-width:2"/><circle cx="470" cy="158" r="6" style="fill:var(--teal)"/>
    <text x="470" y="112" text-anchor="middle" style="fill:var(--teal);font-weight:700">Bounded ★default</text><text x="470" y="132" text-anchor="middle" class="mono" style="fill:var(--muted)">tMax−gracefulTime</text><text x="470" y="186" text-anchor="middle" style="fill:var(--muted)">barely waits</text>
    <line x1="650" y1="150" x2="650" y2="166" style="stroke:var(--accent);stroke-width:2"/><circle cx="650" cy="158" r="5" style="fill:var(--accent)"/>

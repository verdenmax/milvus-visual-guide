...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="归因测试决定要不要重试：问'是请求内容本身逼出这个分支吗'，是则为 Input 错误（怪请求、不可重试、返回用户修正），否则为 System 错误（怪系统或暂时、保持可重试、由 retry.Do 自动再试）">
    ...
    <line x1="300" y1="84" x2="196" y2="126" style="stroke:var(--amber);stroke-width:2"/><path d="M196,126 l3,-11 l8,6 z" style="fill:var(--amber)"/><text x="214" y="106" text-anchor="middle" style="fill:var(--amber);font-weight:700">是 · 怪请求</text>
    <line x1="460" y1="84" x2="564" y2="126" style="stroke:var(--teal);stroke-width:2"/><path d="M564,126 l-11,-3 l5,-9 z" style="fill:var(--teal)"/><text x="548" y="106" text-anchor="middle" style="fill:var(--teal);font-weight:700">否 · 怪系统/暂时</text>
...
<div class="fig">
  <svg viewBox="0 0 760 300" role="img" aria-label="The blame test decides whether to retry: ask 'did the request content itself force this branch'; if yes it's an Input error (blame the request, no retry, return for the user to fix); if no it's a System error (system or transient, stays retriable, retry.Do auto-retries)">
    ...
    <line x1="300" y1="84" x2="196" y2="126" style="stroke:var(--amber);stroke-width:2"/><path d="M196,126 l3,-11 l8,6 z" style="fill:var(--amber)"/><text x="210" y="106" text-anchor="middle" style="fill:var(--amber);font-weight:700">yes · request</text>
    <line x1="460" y1="84" x2="564" y2="126" style="stroke:var(--teal);stroke-width:2"/><path d="M564,126 l-11,-3 l5,-9 z" style="fill:var(--teal)"/><text x="550" y="106" text-anchor="middle" style="fill:var(--teal);font-weight:700">no · system/transient</text>
